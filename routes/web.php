...
// Route::middleware(['authuser'])->get('/maintenance', function () {
//     Artisan::call('down');
//     return 'The system is now in maintenance mode.';
// });


// Route::middleware(['authuser'])->get('/restore', function () {
//     Artisan::call('up');
//     return 'The system is now live!';
// });
...
//Client Appointment
Route::get('/appointment/login','AuthenticationController@AppointmentloginPage');
Route::post('/appointmentLogin','AuthenticationController@calendarAppointment');

Route::get('/set','appointmentController@indexAppointment');
Route::post('/set','appointmentController@store');
Route::post('/setReservation','appointmentController@createReservation');
Route::post('/appointmentDashboard','appointmentController@appointmentDashboard');
Route::get('/getAvailableSlots/{date}','appointmentController@getAvailableSlots');
Route::get('/checkSlotAvailability/{date}/{time}','appointmentController@checkSlotAvailability');
Route::post('/cancelAppointment','appointmentController@cancelAppointment');
Route::get('/appointment/logout','AuthenticationController@appointmentlogout');


Route::get('/admin/login','AuthenticationController@authLockPage');
Route::post('/adminlogin','AuthenticationController@adminlogin')->name('admin.login');


Route::get('/calendar','appointmentController@indexpatientAppointment');

// //Authentication  Route
// Route::middleware(['authuser'])->group(function () {
//     Route::get('/sign-in','AuthenticationController@loginPage');
...
//End User
Route::middleware(['authuser'])->group(function () {
    Route::get('/end-user-search','UserController@index');
    Route::post('/addUser','UserController@addUser');
    Route::post('/viewUser','UserController@viewUser');
    Route::post('/updateUser','UserController@update');
});
...
// Dental Appointment
Route::middleware(['authuser'])->group(function () {
    Route::get('/dental-appointment', 'DentalAppointmentController@create')
        ->name('dental.appointment.create');

    Route::post('/dental-appointment', 'DentalAppointmentController@store')
        ->name('dental.appointment.store');

    Route::get('/dental-available-times', 'DentalAppointmentController@availableTimes')
        ->name('dental.appointment.available-times');

    Route::get('/dental-my-appointments', 'DentalAppointmentController@index')
        ->name('dental.appointment.index');

    Route::get('/dental-appointment-history', 'DentalAppointmentController@history')
        ->name('dental.appointment.history');

    Route::post('/dental-reschedule-response', 'DentalAppointmentController@respondToReschedule')
        ->name('dental.appointment.reschedule-response');
...
Route::middleware(['authuser'])->group(function () {
    ...
    Route::get('/employee-health-history-pdf','EmployeeInformationController@generateEHHPDF');
...
#Medical Record Route
    Route::middleware(['authuser'])->group(function () {
    Route::get('/patient-monitoring-search','PatientMedicalRecordController@index');
    Route::get('/patient-monitoring-record','PatientMedicalRecordController@indexRecord'); 
    Route::get('/patient-monitoring-record-SG','PatientMedicalRecordController@indexRecordSG');
    ...
    Route::middleware(['campus.one'])->group(function () {
        Route::get('/doctor-consultations','PatientMedicalRecordController@doctorConsultations')->name('medical.doctor-consultations');
        Route::get('/consultation-records','PatientMedicalRecordController@consultationRecords')->name('medical.consultation-records');
        Route::get('/doctor-consultation/{record}','PatientMedicalRecordController@doctorConsultation')->name('medical.doctor-consultation');
        Route::post('/doctor-consultation/{record}','PatientMedicalRecordController@saveDoctorConsultation')->name('medical.doctor-consultation.save');
        Route::post('/doctor-consultation/{record}/prescription-pdf','PatientMedicalRecordController@prescriptionPdf')->name('medical.doctor-prescription.pdf');
        Route::get('/doctor-consultation/{record}/saved-prescription-pdf','PatientMedicalRecordController@savedPrescriptionPdf')->name('medical.doctor-prescription.saved-pdf');
        Route::get('/nurse-treatment/{record}','PatientMedicalRecordController@nurseTreatment')->name('medical.nurse-treatment');
        Route::post('/nurse-treatment/{record}','PatientMedicalRecordController@saveNurseTreatment')->name('medical.nurse-treatment.save');
    });
    //for record view
    ...
    Route::get('/patient-status', 'PatientViewMedicalRecordController@indeStatus');
    Route::post('/status-logged-out', 'PatientViewMedicalRecordController@statusLogout');
...
#Dental Certificate
    ...
    Route::post('/deleteCertificate','DentalCertController@deleteCert');
...
#Log-Books
    ...
    Route::get('/medical-physical-assessment','LogsController@physicalAssessmet');
    Route::post('/medical-physical-assessment','LogsController@recordsforPhysical');
    ...
    Route::get('/borrow-slip','LogsController@indexBorrow');
    Route::get('/patient-illness-summary','PatientMedicalRecordController@illnessSummary')->name('patient-illness-summary');
    Route::post('/borrowSearch','LogsController@borrowSearch');
    Route::get('/borrow-slip-view','LogsController@borrowSlip');
    Route::post('/saveBorrow','LogsController@saveBorrow');
    Route::post('/borrowModal','LogsController@borrowModal');
    Route::post('/returnedBorrow','LogsController@returnedBorrow');
    Route::post('/editModal','LogsController@editModal');
    Route::post('/updateModal','LogsController@updateModal');
    Route::post('/deleteBorrow','LogsController@deleteBorrow');
...
Route::middleware(['authuser'])->group(function () {
    ...
    Route::delete('/labresult/delete-file/{id}/{type}', 'LabResultController@deleteFile')->name('labresult.deleteFile');
});
...
Route::middleware(['authuser'])->group(function () {
    ...
    Route::get('/doctor-leaves', 'DoctorsController@indexDoctors')->name('doctor-leaves.index');
    Route::post('/doctor-leaves', 'DoctorsController@addLeave')->name('doctor-leaves.store');
    Route::delete('/doctor-leaves/{leave}', 'DoctorsController@deleteLeave')->name('doctor-leaves.destroy');
});
#Signatories
Route::middleware(['authuser'])->group(function () {
