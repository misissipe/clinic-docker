...
class MedClientAddController extends Controller
{
    ...
    public function healthHistory(Request $request){
      ...
      $course = DB::connection($connection)->table('registration as r')
        ->select('c.id', 'c.course_title', 'c.accro', 's.*', 'r.StudentNo', 'r.Course', 'm.course_major', 'r.StudentYear', 'r.SchoolYear', 'r.Semester', 'r.SchoolLevel','r.finalize','r.StudentStatus')
