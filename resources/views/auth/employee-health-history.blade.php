                ...
                <ul class="nav nav-tabs border-0" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="show-tab" data-toggle="tab" href="#show" aria-controls="show" role="tab"
                      ...
                      <span class="align-middle">Show Health History</span>
                    </a>
                  </li>
                </ul>
                    ...
                    <div class="table-responsive">
                      <div class="col-sm-12">
                        <div id="printPart">
                          ...
                          <div class="col-md-12" style="color: #000000">
                            Date of Birth: <input class="bday cert" name="" type="text" value="" id="bday" style="width:20%;font-weight: 400; font-size: 18px; font-style: bold;">
                            Civil Status: <input  class="civil_status cert" name="" type="text" value="" id="civil_status" style="width:11%;font-weight: 400; font-size: 18px; font-style: bold;">
                            Nationality: <input  class="nationality cert" name="" type="text" value="" id="nationality" style="width:11%;font-weight: 400; font-size: 18px; font-style: bold;">
                            Religion: <input  class="religion cert" name="" type="text" value="" id="religion" style="width:11%;font-weight: 400; font-size: 18px; font-style: bold;">
                          </div>
                          <div class="col-md-12" style="color: #000000">
                            Home Address: <input  class="fullname cert" name="" type="text" value="" id="fullname" style="width:90.4%;font-weight: 400; font-size: 18px; font-style: bold;">
                          </div>
                          <div class="col-md-12" style="color: #000000">
                          ...
                          <div class="col-md-12" style="color: #000000">
                            ...
                            Student's Contact No.: <input  class="fullname cert" name="" type="text" value="" id="fullname" style="width:36%;font-weight: 400; font-size: 18px; font-style: bold;">
                          </div>
                          <br>
                                  ...
                                  <div class="row" >
                                    ...
                                    <div class="col-sm-4">
                                      <div class="form-group text-left">
                                        ...
                                        <input class="cert othersFamhis" type="text" id="othersFam" name="othersFamhis" value="{{$data->othersFamhis ?? ''}}" style="width: 55%" disabled>
                                      </div>
                                    </div>
                                  </div>
                                </td>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-10">
                                      ...
                                      <div class="form-group text-left"><input type="checkbox" id="smoking" name="personal_his[]" value="Smoking">
                                        ...
                                        <input class="cert" type="number" id="sticksPer" name="sticksPerDay" style="width: 10%" value="{{$data->sticksPerDay ?? ''}}" disabled>
                                        ...
                                        <input class="cert" type="number" id="Years" name="forYears" value="{{$data->forYears ?? ''}}" style="width: 10%" disabled>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group text-left"><br>
                                            ...
                                            <input class="cert" type="number" id="shot" name="shotPerday" value="{{$data->shot ?? ''}}" style="width: 10%" disabled>
                                            <label style="text-transform: capitalize;color:black;font-weight: 400; font-size: 14px;" for="shots">shot per</label>
                                            <input class="cert" type="number" id="beers" name="beerPerday" value="{{$data->shotPer ?? ''}}" style="width: 10%" disabled>
                                            ...
                                            <input class="cert" type="number" id="" name="shotPerday" value="{{$data->beer ?? ''}}" style="width: 10%" disabled>
                                            <label style="text-transform: capitalize;color:black;font-weight: 400; font-size: 14px;" for="shots">beer per</label>
                                            <input class="cert" type="number" id="" name="shotPerday" value="{{$data->beerPer ?? ''}}" style="width: 10%" disabled>
                                            <label style="text-transform: capitalize;color:black;font-weight: 400; font-size: 14px;" for="shots">)</label>
                                        </div>
                                    </div>
                                </div>                              
                                    ...
                                    <div class="row">
                                      <div class="col-sm-2">
                                        <div class="form-group">
                                          ...
                                          <label style="text-transform: capitalize;color:black;font-weight: 400; font-size: 14px;" for="BCG">BCG</label><br>
                                      ...
                                      <div class="col-sm-4">
                                        <div class="form-group">
                                          ...
                                          <label style="text-transform: capitalize;color:black;font-weight: 400; font-size: 14px;" for="DPT">DPT I,II,II, Booster Dose</label><br>
                                          <input type="checkbox" id="others" name="immunization_his[]" value="othersImmu">        
                                          <label style="text-transform: capitalize;color:black;font-weight: 400; font-size: 14px;" for="vehicle2">Others:</label>
                                          <input class="cert othersImmu" type="text" id="others" name="othersImmu" value="{{$data->othersImmu ?? ''}}" style="width:70%" disabled>
                                        </div>
                                      </div>
                                      <div class="col-sm-2">
                                        <div class="form-group">
...
{{-- SHOW-TAB --}}
                  <div class="tab-pane active" id="show" aria-labelledby="show-tab" role="tabpanel">
                    <div class="table-responsive">
                      <div class="col-sm-12">
                        <form  action="/updateEmployeeRecord" method="post" id="updateForm">
                        @csrf
                         <input type="hidden" class="col-sm-8 border-0 hhId" name="hhId" value="{{ $response->AgencyNumber }}" id="id" style="font-weight:400;color:rgb(58, 57, 57)" >
                          ...
                          <input type="hidden" class="col-sm-8 border-0 id" name="id" value="{{ $response->id }}" id="id" style="font-weight:400;color:rgb(58, 57, 57)" >
                          {{-- <input type="text" class="col-sm-8 border-0 id" name="employee_id" value="{{ $response->id ?? '' }}" id="id" style="font-weight:400;color:rgb(58, 57, 57)" > --}}
                          <input type="hidden" class="col-sm-8 border-0 id" name="LastName" value="{{ $response->LastName}}" id="lastname" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="FirstName" value="{{ $response->FirstName }}" id="firstname" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="MiddleName" value="{{ $response->MiddleName }}" id="middlename" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="Sex" value="{{ (new AESCipher)->decrypt($response->Sex)}}" id="gender" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="DateOfBirth" value="{{ (new AESCipher)->decrypt($response->DateOfBirth) }}" id="bday" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="EmploymentStatus" value="{{ $response->EmploymentStatus}}" id="course" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="DepartmentName" value="{{ $response->DepartmentName }}" id="course" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="Cellphone" value="{{ $response->Cellphone }}" id="bday" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="CivilStatus" value="{{ (new AESCipher)->decrypt($response->CivilStatus) }}" id="middlename" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="Citizenship" value="{{ (new AESCipher)->decrypt($response->Citizenship)}}" id="firstname" style="font-weight:400;color:rgb(58, 57, 57)" > 
                          <input type="hidden" class="col-sm-8 border-0 id" name="RBarangay" value="{{ (new AESCipher)->decrypt($response->RBarangay) }}" id="firstname" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="citymunDesc" value="{{ $response->citymunDesc }}" id="middlename" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="provDesc" value="{{ $response->provDesc}}" id="firstname" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class="col-sm-8 border-0 id" name="EmailAddress" value="{{ $response->EmailAddress}}" id="firstname" style="font-weight:400;color:rgb(58, 57, 57)" >     
                          ...
                          <div class="title">
                              ...
                              <div class="col-sm-2">
                                <div class="form-group">
                                  ...
                                  <input type="checkbox" id="eye" name="family_his[]" value="Eye Disorder">
                                    ...
                                    <input class="form-control othersFamhis" type="text" id="othersFamhisInput" name="othersFamhis" value="{{$data->othersFamhis ?? ''}}" disabled>
                                </div>
                              </div>
                              <div class="col-sm-2" style="border-left: 1px solid rgb(207, 206, 206)" >
                                <div class="form-group">
                                  ...
                                  <div class="form-group w-50">
                                    ...
                                    <input class="form-control" type="number" id="sticksPerDayInput" name="sticksPerDay" value="{{$data->sticksPerDay ?? ''}}" disabled>
                                    <label for="year">for year/s</label><br>
                                    <input class="form-control" type="number" id="forYearsInput" name="forYears" value="{{$data->forYears ?? ''}}" disabled>
                                  </div>
                                </div>
                              </div>
                              <div class="col-sm-4">
                                <div class="form-group"><br>
                                  ...
                                  <div class="row align-items-center">
                                    <div class="col-md-3 form-group">
                                        <input class="form-control shotInput" type="number" id="shotInput" name="shot" value="{{$data->shot ?? ''}}" disabled>
                                    </div>
                                    <div class="col-md-3 text-center">
                                        <label for="for shot">Shot per</label>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <input class="form-control shotPerInput" type="number" id="shotPerInput" name="shotPer" value="{{$data->shotPer ?? ''}}" disabled>
                                    </div>
                                </div>
                                <div class="row align-items-center">
                                  <div class="col-md-3 form-group">
                                      <input class="form-control beerInput" type="number" id="beerInput" name="beer" value="{{$data->beer ?? ''}}" disabled>
                                  </div>
                                  <div class="col-md-3 text-center">
                                      <label for="for shot">ber per</label>
                                  </div>
                                  <div class="col-md-3 form-group">
                                      <input class="form-control beerperInput" type="number" id="beerPerInput" name="beerPer" value="{{$data->beerPer ?? ''}}" disabled>
                                  </div>
                              </div>                        
                                </div>
                              </div>
                            ...
                            {{-- Past Illness --}}
                                ...
                                <div class="col-sm-2" style="border-left: 1px solid rgb(207, 206, 206)" >
                                  <div class="form-group">
                                    <div>
                                      ...
                                      <label for="vehicle2">Others:</label><br>
                                      <input class="form-control othersPres" type="text" id="othersPreIllInput" name="othersPreIll" value="{{$data->othersPreIll ?? ''}}" disabled>       
                                  </div>
                                </div>
                                <div class="col-sm-2">
                                  <div class="form-group"><br>
                              ...
                              <input type="text" class="form-control hospitalization_details" id="hospitalization_details" name="hos_detail" value="{{$data->hos_detail ?? ''}}" placeholder="" disabled><br>
                              ...
                              <input type="text" class="form-control medicine_details" id="medicine_details" name="med_detail" value="{{$data->med_detail ?? ''}}" placeholder="" disabled><br>
                              ...
                              <input type="text" class="form-control allergies_details" id="allergies_details" name="al_detail" value="{{$data->al_detail ?? ''}}" placeholder="" disabled><br>
                                    <hr> 
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-sm-4">
                                    <div class="form-group">
                                      ...
                                      <label for="vehicle2">Others:</label><br>
                                      <input class="form-control othersImmu" type="text" id="othersImmuInput" name="othersImmu" value="{{$data->othersImmu ?? ''}}" disabled>
                                    </div>
                                  </div>
                                  <div class="col-sm-2">
                                    <div class="form-group">
        ...
        <div class="col-md-2">
          <div class="card">
            ...
            <div class="card-body" style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 20px;">
              <label style="font-size: 18px;" id="id">{{$response->AgencyNumber}}</label>
              <label style="font-size: 14px;" id="id">{{$response->EmploymentStatus}}</label>
            </div>
          </div>  
          <div class="card">
            <div class="card-body" style="background-color:rgb(110, 155, 222);">
              <div class="row" >
                <div class="col-12"  style="color:#f5f2f2;font-weight:bold;font-size:12px">
                  ...
                  <hr>
                  <div class="form-group">
                    First Name: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{ $response->FirstName}}</label><br>
                    Middle Name: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{  $response->MiddleName}}</label><br>
                    Last Name: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{ $response->LastName}}</label><br>
                    ...
                    Gender: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{(new AESCipher)->decrypt($response->Sex)}}</label><br>
                    <hr>
                    DOB: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{ date('m-d-Y', strtotime((new AESCipher)->decrypt($response->DateOfBirth)))}}</label><br>
                    Civil Status: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{(new AESCipher)->decrypt($response->CivilStatus)}}</label><br>
                    Nationality: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{(new AESCipher)->decrypt($response->Citizenship)}}</label><br>
                    {{-- Religion: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{$response[0]['MiddleName']}}</label><br> --}}
                  </div>
                  <hr>
                    Contact Number: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{$response->Cellphone}}</label><br>
                </div>
                <div class="col-12">
                  <div class="form-group">
...
//  });
 ...
 //Family History 
    const othersFamhis = "{{$data->othersFamhis ?? ''}}";
    ...
    //Present Illness
      const  othersPreIll = "{{$data-> othersPreIll ?? ''}}";
    ...
    //Immunization History
    const  othersImmu = "{{$data-> othersImmu ?? ''}}";
    ...
    //Personal History
    const sticksPerDay = "{{$data->sticksPerDay ?? ''}}";
    const forYears = "{{$data->forYears ?? ''}}";
  ...
  const shotPer = "{{$data->shotPer ?? ''}}";
  const beer = "{{$data->beer ?? ''}}";
  const beerPer = "{{$data->beerPer ?? ''}}";
  ...
  //maintenance
  const medicine_mnt = "{{$data->medicine_mnt ?? ''}}";
  ...
  $(document).ready(function() {
    var family_his = "{{$data->family_his ?? ''}}";
    var past_illness = "{{$data->past_illness ?? ''}}";
    var present_illness = "{{$data->present_illness ?? ''}}";
    var personal_his = "{{$data->personal_his ?? ''}}";
    var immunization_his = "{{$data->immunization_his ?? ''}}";
    var hospitalization = "{{$data->hospitalization ?? ''}}";
    var medicine_mnt = "{{$data->medicine_mnt ?? ''}}";
