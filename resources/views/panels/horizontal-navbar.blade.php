        ...
        <ul class="nav navbar-nav float-right d-flex align-items-center">
          ...
          <li class="nav-item nav-search"><a class="nav-link nav-link-search pt-2"><i class="ficon bx bx-search"></i></a>
            <div class="search-input">
              ...
              <input class="input" type="text" placeholder="Explore CMIS..." tabindex="-1" data-search="template-search">
          ...
          <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              <div class="user-nav d-lg-flex d-none">
                <span class="user-name">{{ session('name')}}</span><span class="user-status">{{ session('role')}}</span>
              </div>
