...
<section id="basic-datatable">
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <button type="button" class="btn btn-primary float-right button" data-toggle="modal" data-target="#addMeasure" id="addmeasure"><a style="color: rgb(255, 255, 255); font-size: 15px;">Add Unit</a></button>
            ...
            <table class="table table-sm recordTable table-bordered table-striped zero-configuration" id="recordTable" style="text-align:center;">
              <thead>
                <tr>
                  ...
                  <th style="color:white;">Unit of Measurement</th>
              ...
              @foreach($view as $data)  
                <tr>    
                  ...
                  <td style="text-transform:capitalize;">{{$data->unit_of_measurement}}</td>
  ...
  @include('modal.addMeasure')
  @include('modal.editMeasure')
</section>
@endsection
{{-- vendor scripts --}}
...
$("#addMeasureModal").submit(function(e) {
  e.preventDefault();
    ...
    $(document).on('click', '.editModal', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('.id').val(id);
                $('.measure').val(response.unit_of_measurement);
            } 
        });
    });
});
...
$(document).ready(function() {
    $('#editMeasureModal').submit(function(e) {
        e.preventDefault();
        var form = $(this);
       var actionUrl = form.attr('action');
