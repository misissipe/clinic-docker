        ...
        <div class="card-content">
          <div class="user-profile-images position-relative">
            ...
            <div class="position-absolute d-flex align-items-center" style="bottom: -40px; left: 20px;">
              <img src="{{ session('photo') ? session('photo') : asset('images/icon/default-profile.png') }}" class="user-profile-image rounded-circle border" alt="User Profile Image" height="90" width="90">
              <div class="ms-1">
