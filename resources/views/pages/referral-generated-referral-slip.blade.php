...
{{-- title --}}
@section('title','Generated Referral Slip')
...
{{--generate-tab--}}
                <div class="tab-pane " id="generate" aria-labelledby="generate-tab" role="tabpanel">
                  ...
                  <div id="printThis">
                    ...
                    <div  style="font-weight: 400; font-size: 18px;text-align: right;color:black;">
                      School Year:
                      <input  class="col-2 cert" name="" type="text" value="{{$addYear ?? ''}}" id="fullname" >
                    </div>
                    <div  style="font-weight: 400; font-size: 18px;text-align: right;color:black;">
                      Date:
                    ...
                    <div style="font-weight: 400; font-size: 18px;color:black;margin-left:100px;">
                       <input class="textbox" type="checkbox" id="others" name="referTo[]" value="others">
                        ...
                        <input class="others col-sm-2 cert" type="text" id="others" name="others" value="{{$generate->others ?? ''}}" >
                    </div> 
                  </div>
                  <div class="form-group col-sm-12" style="font-weight: 300; font-size: 18px; align-text:middle;color:black;">
                    ...
                    <div class="row">
                      Date of Birth:
                      <input  class=" cert bday" type="text" value="{{date('m-d-Y', strtotime($generate->bday))}}" id="bday" style="width:15.9%;text-align:center">
                      Civil Status:
                      <input  class=" cert civil_status" type="text" value="{{$generate->civil_stat}}" id="civil_status" style="width:15.7%;text-align:center">
                      Religion:
                      <input  class="cert religion" type="text" value="{{$generate->religion}}" id="religion" style="width:19.3%;text-align:center">
                      Height:
                      <input  class="cert religion" type="text" value="{{$generate->weight ?? ''}}" id="religion" style="width:8%;text-align:center">
                      Weight:
                      <input  class="cert religion" type="text" value="{{$generate->height ?? ''}}" id="religion" style="width:8%;text-align:center">
                    </div>
                    ...
                    <div class="row" style="color:black;">
                      Parent/Guardian:
                      <input  class=" cert guardian" type="text" value="{{$generate->EC_name ?? $generate->guardian}}" id="guardian" style="width:41.5%">
                      Parent/Guardian Contact No.:
                      <input  class="cert p_contactNo" type="text" value="{{$generate->EC_contactNo ?? $generate->g_ContactNo}}" id="p_contactNo" style="width:23%">
                    </div>
                    <div class="row" style="color:black;">
                      Guardian Address:
                  ...
                  <div class="line" style="border-bottom: 1px solid rgb(110, 109, 109);margin:2px"></div>
                  <div class="line" style="border-bottom: 1px solid rgb(110, 109, 109);margin:2px"></div>
                  <br>
                 <div class="row" style="color:black;">
                      <div class="col-md-6">
                        <div class="form-group">
                         CHIEF COMPLAINT/S:
                          <textarea class="cert " rows="1" name="chief_complaint" style="width:68%">{{$generate->complaint ?? ''}}</textarea>
                        </div><br>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          VITAL SIGNS:<br>
                          TEMP - <input type="text" class="cert d-inline-block " style="width:40%; display:inline-block;" value="{{$generate->temp ?? ''}}" name="temp"> 
                          PR - <input type="text" class="cert d-inline-block " style="width:40.5%; display:inline-block;" value="{{$generate->pr ?? ''}}" name="pr"><br>
                          RR - <input type="text" class="cert d-inline-block " style="width:44%; display:inline-block;" value="{{$generate->rr ?? ''}}" name="rr"> 
                          BP - <input type="text" class="cert d-inline-block " style="width:40.5%; display:inline-block;" value="{{$generate->bp ?? ''}}" name="bp">
                        </div>
                      </div>
                      <br>
                      <div class="col-md-6">
                        <div class="form-group">
                          ACTION TAKEN:
                          <textarea class="cert " rows="1" name="action_taken" style="width:75%">{{$generate->action_taken ?? ''}}</textarea>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          REASON/S FOR REFERRAL:
                          <textarea class="cert " rows="1" name="referral_reason" style="width:60%">{{$generate->reason ?? ''}}</textarea>
                        </div>
                      </div>
                    </div><br>
                  <div style="font-weight: 400; font-size: 18px; text-align: left;color:black;">
                    Referred by:
                    <input  class="col-3 cert" name="" type="text" value="   {{$doctor->FirstName}} {{$doctor->MiddleName}}. {{$doctor->LastName}} "  style="text-align:center">
                  </div>
                  <div class="for"  style="color:black;margin-left:140px">
                  ...
                  <div style="font-weight: 400; font-size: 18px;text-align: right;color:black;">
                    Course:
                    <input  class="col-2 course cert " name="" type="text" value="{{$generate->accro ?? ''}}" id="course">
                  </div>
                  <div style="font-weight: 400; font-size: 18px;text-align: right;color:black;">
                    School Year:
                    <input  class="col-2 cert" name="" type="text" value="{{$addYear ?? ''}}" id="sy" >
                  </div>
                  ...
                  <div class="d-flex justify-content-left" style="font-weight: 700; font-size: 20px; font-style: bold; text-align:center;color:black;">Action taken/Remarks:</div>
...
{{--print-tab--}}
                <div class="tab-pane active" id="print" aria-labelledby="print-tab" role="tabpanel">
                  <div id="">
                    ...
                    <div class="form-group col-sm-12" >
                      ...
                      <input  class="cert religion" type="text" value="{{$generate->religion}}" id="religion" style="width:19.3%;text-align:center">
                      Height:
                      <input  class="cert religion" type="text" value="{{$generate->weight ?? ''}}" id="religion" style="width:7%;text-align:center">
                      Weight:
                      <input  class="cert religion" type="text" value="{{$generate->height ?? ''}}" id="religion" style="width:7%;text-align:center">
                    </div>
                      <div class="row" style="color:black;">
                        Boarding House Address:
                        <input  class=" cert bhAddress" type="text" value="{{$generate->b_brgy}}, {{$generate->b_city}}, {{$generate->b_province}}" id="bhAddress" style="width:81%">
                      ...
                      <div class="row" style="color:black;">
                        Parent/Guardian:
                        <input  class=" cert guardian" type="text" value="{{$generate->EC_name ?? $generate->guardian}}" id="guardian" style="width:37%">
                        Parent/Guardian Contact No.:
                        <input  class="cert p_contactNo" type="text" value="{{$generate->EC_contactNo ??  $generate->g_ContactNo}}" id="p_contactNo" style="width:29.2%">
                      </div>
                      <div class="row" style="color:black;">
                        Guardian Address:
                    ...
                    <div class="row" style="color:black;">
                      <div class="col-md-6">
                        <div class="form-group">
                         CHIEF COMPLAINT/S:
                          <textarea class="cert " rows="1" name="chief_complaint" style="width:65%">{{$generate->complaint ?? ''}}</textarea>
                        </div><br>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12 row" style="color:black;">
                      Referred by:<br>
                      <input  class="cert " name="" type="text" value="  {{$doctor->FirstName}} {{$doctor->MiddleName}}. {{$doctor->LastName}} " id="" style="width:23%;">
                    </div>
    ...
    <div class="col-md-1">
      ...
      <div class="card" style="display: flex; align-items: center; justify-content: center; background-color: rgb(84, 145, 236); height: 40px; margin-bottom: 10px;">
        <div class="card-body">
          <form action="/generated-referral-slip-pdf" method="get" target="_blank" class="float-right">
            <input type="hidden" name="id" value="{{$request->to_id}}">
