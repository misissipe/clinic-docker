...
{{-- title --}}
@section('title','Dental Records of Visit')
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="profile" aria-labelledby="profile-tab" role="tabpanel">
                <div class="table-responsive view-all">
                  ...
                  <form action="/records-of-visit" method="post" id="submitBtn">
                    @csrf
                  ...
                  <table class="table table-sm recordTable cell-border" id="print">
                    ...
                    <thead>
                      <tr>
                          ...
                          <th style="color:rgb(0, 0, 0); text-align: center; border: 1px solid rgb(226, 222, 222);">remarks</th>
...
$(document).ready(function() {
    $('#submitToGenerate').click(function(event) {
        ...
        window.location.href = `/generated-record-of-visit?monthSearch=${monthSearch}&year=${year}`;
    });
});
