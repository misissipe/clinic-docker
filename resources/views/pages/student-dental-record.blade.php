...
$(document).ready(function() {
        ...
        function updateTable(data) {
          ...
          table.row.add([
              ...
              `<td style="text-align:center">
                  <a class="dropdown-item chart" href="#" id="" data-id="${student.encryptedStudentNo}"><i class="fa fa-user-md"></i></a>
              </td>`
          ]).draw(false);
      });
 ...
 $(document).on('click', '.chart', function(){
  var id = $(this).data('id');
  // console.log(id);
  window.location.href = "/student-dental-chart?StudentId=" + encodeURIComponent(id);
});
