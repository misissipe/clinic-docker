          ...
          <div class="card border">
              <div class="card-body mt-0 p-1">
                <ul class="nav nav-tabs border-0" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="print-tab" data-toggle="tab" href="#print" aria-controls="print" role="tab"
                ...
                <div class="tab-content">
                  <div class="tab-pane " id="print" aria-labelledby="print-tab" role="tabpanel">
                    ...
                    <div class="row" style="margin-top: 8px;">
                        <div style="display: inline-block; width: 80px; height: 100px;"></div> 
                        <div style="text-align: right; margin-left: auto;">
                            <div style="font-weight: 400; font-size: 16px; color: black;">Course:
                            ...
                            <div style="font-weight: 400; font-size: 16px; color: black;">School Year:
                                <input class="col-4 cert" name="" type="text" value="{{$addYear ?? ''}}" id="fullname" style="font-weight: 400; font-size: 14px; font-style: bold;">
                            </div>
                        </div>
                    </div>                    
                      <div class="row">
                        <div class="col-lg-12 d-flex justify-content-left" style="font-weight: 700; font-size: 16px; font-style: bold; text-align:center;color:black;"><u>PERSONAL DATA</u></div>
                      </div>
                      <div class=" col-md-12" style="color: #000000">
                        Name: <input  class="firstname cert" name="" type="text" value="{{$response->LastName ?? ''}}" id="firstname" style="width:25%;font-weight: 400; font-size: 14px; font-style: bold;text-align:center"> <input  class=" cert" name="middlename" type="text" value="{{$response->FirstName ?? ''}}" id="middlename" style="width:25.5%;font-weight: 400; font-size: 14px; font-style: bold;text-align:center"> <input  class="lastname cert" name="" type="text" value="{{$response->MiddleName ?? ''}}" id="lastname" style="width:20.8%;font-weight: 400; font-size: 14px; font-style: bold;text-align:center">
                        Age: <input  class="age cert" name="" type="text" value="{{$age ?? ''}}" id="age" style="width:5%;font-weight: 400; font-size: 14px; font-style: bold;">
                        Gender: <input  class="gender cert" name="" type="text" value="{{$gender ?? ''}}" id="gender" style="width:10%;font-weight: 400; font-size: 14px; font-style: bold;">
                      </div>
                      <div class="col-lg-12 d-flex justify-content-left" style="font-weight: 400; font-size: 15px; font-style: italic;">
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;(Last)
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;(First)
                        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;(Middle)
                      </div>
                      <div class="col-md-12" style="color: #000000">
                        Date of Birth: <input  class="bday cert" name="" type="text" value="{{$response->BirthDate ?? ''}}" id="bday" style="width:20%;font-weight: 400; font-size: 14px; font-style: bold;">
                        Civil Status: <input  class="civil_status cert" name="" type="text" value="{{$response->civil_status ?? ''}}" id="civil_status" style="width:14%;font-weight: 400; font-size: 14px; font-style: bold;">
                        Nationality: <input  class="nationality cert" name="" type="text" value="{{$response->nationality ?? ''}}" id="nationality" style="width:15%;font-weight: 400; font-size: 14px; font-style: bold;">
                        Religion: <input  class="religion cert" name="" type="text" value="{{$response->religion ?? ''}}" id="religion" style="width:20%;font-weight: 400; font-size: 14px; font-style: bold;">
                      </div>
                      <div class="col-md-12" style="color: #000000">
                        Home Address: <input  class="fullname cert" name="" type="text" value="{{$response->p_street ?? ''}}, {{$response->p_municipality ?? ''}} {{$response->p_province ?? ''}}" id="fullname" style="width:90.4%;font-weight: 400; font-size: 12px; font-style: bold;">
                      </div>
                      <div class="col-md-12" style="color: #000000">
                        Father's Name: <input  class="father_name cert" name="" type="text" value="{{$response->father_name ?? ''}}" id="father_name" style="width:40.2%;font-weight: 400; font-size: 14px; font-style: bold;">
                        Mother's Name: <input  class="mother_name cert" name="" type="text" value="{{$response->mother_name ?? ''}}" id="mother_name" style="width:39.6%;font-weight: 400; font-size: 14px; font-style: bold;">
                      </div>
                      <div class="col-md-12" style="color: #000000">
                        Occupation: <input  class="father_occu cert" name="" type="text" value="{{$response->father_occu ?? ''}}" id="father_occu" style="width:42%;font-weight: 400; font-size: 14px; font-style: bold;">
                        Occupation: <input  class="mother_occu cert" name="" type="text" value="{{$response->mother_occu ?? ''}}" id="mother_occu" style="width:42%;font-weight: 400; font-size: 14px; font-style: bold;">
                      </div>
                      <div class="col-md-12" style="color: #000000">
                      ...
                      <div class="col-md-12" style="color: #000000">
                        Guardian: <input  class="emer_name cert" name="" type="text" value="{{$response->emer_name ?? ''}}" id="emer_name" style="width:43.3%;font-weight: 400; font-size: 14px; font-style: bold;">
                        Parent's/Guardian Contact No.: <input  class="fullname cert" name="" type="text" value="{{$response->emer_contact ?? ''}}" id="fullname" style="width:30.43%;font-weight: 400; font-size: 14px; font-style: bold;">
                      </div>
                      <div class="col-md-12" style="color: #000000">
                        Guardian Address: <input  class="emer_street cert" name="" type="text" value="{{$response->emer_street ?? ''}}, {{$response->emer_city ?? ''}} {{$response->emer_province ?? ''}}" id="emer_street" style="width:38.2%;font-weight: 400; font-size: 12px; font-style: bold;">
                        Student's Contact No.: <input  class="fullname cert" name="" type="text" value="{{$response->ContactNo ?? ''}}" id="fullname" style="width:36%;font-weight: 400; font-size: 14px; font-style: bold;">
                      </div>
                      ...
                      <div class="col-lg-12 d-flex justify-content-center" style="font-weight: 700; font-size: 16px; font-style: bold; text-align:center;color:black;">PLEASE CHECK THE BOX IF ONE OF THE FOLLOWING IS APPLICABLE</div>
                      <div class="title">
                          <div class="col-lg-12 d-flex justify-content-center" style="font-weight: 700; font-size: 16px; font-style: bold; text-align:center;color:black;"><u>MEDICAL AND SOCIAL HEALTH HISTORY</u></div>
                        </div>
                                  ...
                                  <div class="row">
                                    <div class="col-sm-10">
                                      ...
                                      <div class="form-group text-left"><input type="checkbox" id="smoking" name="personal_his[]" value="Smoking">
                                        ...
                                        <input class="cert" type="number" id="sticksPer" name="sticksPerDay" style="width: 10%" value="{{$response->sticksPerDay ?? ''}}" disabled>
                                        ...
                                        <input class="cert" type="number" id="Years" name="forYears" value="{{$response->sticksPerDay ?? ''}}" style="width: 10%" disabled>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group text-left"><br>
                                            ...
                                            <input class="cert" type="number" id="shot" name="shotPerday" value="{{$response->shot ?? ''}}" style="width: 10%" disabled>
                                            <label style="text-transform: capitalize;color:black;font-weight: 400; font-size: 14px;" for="shots">shot per</label>
                                            <input class="cert" type="number" id="beers" name="beerPerday" value="{{$response->shotPer ?? ''}}" style="width: 10%" disabled>
                                            ...
                                            <input class="cert" type="number" id="" name="shotPerday" value="{{$response->beer ?? ''}}" style="width: 10%" disabled>
                                            <label style="text-transform: capitalize;color:black;font-weight: 400; font-size: 14px;" for="shots">beer per</label>
                                            <input class="cert" type="number" id="" name="shotPerday" value="{{$response->beerPer ?? ''}}" style="width: 10%" disabled>
                                            <label style="text-transform: capitalize;color:black;font-weight: 400; font-size: 14px;" for="shots">)</label>
                                        </div>
                                    </div>
                                </div>                              
                                ...
                                <div class="row">
                                  <div class="col-sm-4">
                                    <div class="form-group text-left" >
                                      ...
                                      <input type="checkbox" id="ChestPain" name="present_illness[]" value="Chest Pain">
                                        ...
                                        <input class="cert othersPres" type="text" id="othersPre" name="othersPreIll" value="{{$response->present_illness}}" style="width:55%" disabled>             
                                    </div>
                                  </div>
                                  <div class="col-sm-3 ">
                                    <div class="form-group text-left"><br>
                                  ...
                                  <div class="col-sm-4">
                                    <div class="form-group  text-left"><br>
                                      ...
                                      <label style="text-transform: capitalize;color:black;font-weight: 400; font-size: 14px;" for="Breathing">Difficulty of Breathing</label><br>
                                    </div>
                                  </div>
                                </div>
                              </td>
                  ...
                  <div class="tab-pane active" id="show" aria-labelledby="show-tab" role="tabpanel">
                    <div class="table-responsive">
                      <div class="col-sm-12">
                        ...
                        @csrf
                        <input type="text" class=" col-sm-8 border-0 id" name="patientId" value="{{$newencryptedId}}" id="id" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="lastname" value="{{$response->LastName}}" id="lastname" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="firstname" value="{{$response->FirstName}}" id="firstname" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="middlename" value="{{$response->MiddleName}}" id="middlename" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        ...
                        <input type="text" class=" col-sm-8 border-0 id" name="bday" value="{{$response->BirthDate}}" id="bday" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="course" value="{{$course->course_title}}" id="course" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        ...
                        <input type="text" class=" col-sm-8 border-0 id" name="StudentYear" value="{{$course->StudentYear}}" id="lastname" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="SchoolLevel" value="{{$course->SchoolLevel}}" id="SchoolLevel" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="ContactNo" value="{{$response->ContactNo}}" id="bday" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="civil_status" value="{{$response->civil_status}}" id="middlename" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="nationality" value="{{$response->nationality}}" id="firstname" style="font-weight:400;color:rgb(58, 57, 57)" hidden> 
                        <input type="text" class=" col-sm-8 border-0 id" name="religion" value="{{$response->religion}}" id="religion" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="p_street" value="{{$response->p_street}}" id="firstname" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="p_municipality" value="{{$response->p_municipality}}" id="middlename" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="p_province" value="{{$response->p_province}}" id="firstname" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="father_name" value="{{$response->father_name}}" id="firstname" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="mother_name" value="{{$response->mother_name}}" id="middlename" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="father_occu" value="{{$response->father_occu}}" id="gender" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="mother_occu" value="{{$response->mother_occu}}" id="bday" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="emer_name" value="{{$response->emer_name}}" id="course" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="emer_street" value="{{$response->emer_street}}" id="bday" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="emer_city" value="{{$response->emer_city}}" id="course" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="emer_province" value="{{$response->emer_province}}" id="lastname" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                        <input type="text" class=" col-sm-8 border-0 id" name="emer_contact" value="{{$response->emer_contact}}" id="gender" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
                            ...
                            <div class="col-sm-2">
                              <div class="form-group">
                                ...
                                <input type="checkbox" id="eye" name="family_his[]" value="Eye Disorder">
                                  ...
                                  <input class="form-control othersFamhis" type="text" id="othersFamhisInput" name="othersFamhis" value="{{$response->othersFamhis}}" disabled>
                              </div>
                            </div>
                              ...
                              <div class="form-group">
                                <div>
                                  ...
                                  <div class="form-group w-50">
                                    <label for="sticksPerDayInput">sticks/day</label><br>
                                    <input class="form-control sticksPerDayInput" type="number" id="sticksPerDayInput" name="sticksPerDay" value="{{$response->sticksPerDay}}" disabled>
                                    <label for="forYearsInput">for year/s</label><br>
                                    <input class="form-control forYearsInput" type="number" id="forYearsInput" name="forYears" value="{{$response->forYears}}" disabled>
                                  </div>
                              </div>
                            </div>
                               <div class="col-sm-4">
                                <div class="form-group"><br>
                                  ...
                                  <div class="row align-items-center">
                                    <div class="col-md-3 form-group">
                                        <input class="form-control shotInput" type="number" id="shotInput" name="shot" value="{{$response->shot}}" disabled>
                                    </div>
                                    <div class="col-md-4 text-center">
                                        <label for="for shot">Shot per</label>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <input class="form-control shotPerInput" type="number" id="shotPerInput" name="shotPer" value="{{$response->shotPer}}" disabled>
                                    </div>
                                </div>
                                <div class="row align-items-center">
                                  <div class="col-md-3 form-group">
                                      <input class="form-control beerInput" type="number" id="beerInput" name="beer" value="{{$response->beer}}" disabled>
                                  </div>
                                  <div class="col-md-4 text-center">
                                      <label for="for shot">ber per</label>
                                  </div>
                                  <div class="col-md-3 form-group">
                                      <input class="form-control beerPerInput" type="number" id="beerPerInput" name="beerPer" value="{{$response->beerPer}}" disabled>
                                  </div>
                              </div>                        
                                </div>
                              </div>
...
{{-- Present Illness --}}
                              <div class="col-sm-2" style="border-left: 1px solid rgb(207, 206, 206)" >
                                <div class="form-group">
                                  <div>
                                    ...
                                    <label for="vehicle2">Others:</label><br>
                                    <input class="form-control othersPres" type="text" id="othersPreIllInput" name="othersPreIll" value="{{$response->othersPreIll}}" disabled>      
                                </div>
                              </div>
                              <div class="col-sm-2">
                                <div class="form-group"><br>
                            ...
                            <input type="text" class="form-control allergies_details" id="allergies_details" name="al_detail" value="{{$response->al_detail}}" placeholder="" disabled><br><hr> 
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-4">
                                  <div class="form-group">
                                    ...
                                    <label for="vehicle2">Others:</label><br>
                                    <input class="form-control othersImmu" type="text" id="othersImmuInput" name="othersImmu" value="{{$response->othersImmu}}" disabled>
                                  </div>
                                </div>
                                <div class="col-sm-2">
                                  <div class="form-group">
...
{{-- else statement --}}
                        ...
                        <form  action="/updateStdentRecord" method="post" id="updateForm">
                          @csrf
                          <input type="hidden" class=" col-sm-8 border-0 id" name="course" value="{{$course->course_title}}" id="course" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class=" col-sm-8 border-0 id" name="accro" value="{{$course->accro}}" id="accro" style="font-weight:400;color:rgb(58, 57, 57)" >
                          <input type="hidden" class=" col-sm-8 border-0 id" name="major" value="{{$course->course_major}}" id="major" style="font-weight:400;color:rgb(58, 57, 57)" >
                                ...
                                <div class="col-sm-2" style="border-left: 1px solid rgb(207, 206, 206)" >
                                  <div class="form-group">
                                    <div>
                                      ...
                                      <label for="Dizziness">Dizziness</label><br>    
                                      <input type="checkbox" id="othersPreIllCheckbox" name="present_illness[]" value="othersPreIll">        
                                      <label for="othersPreIllCheckbox">Others:</label><br>
                                      <input class="form-control othersPres" type="text" id="othersPreIllInput" name="othersPreIll" value="{{$response->othersPreIll}}" disabled>
                                  </div>
                                </div>
                                <div class="col-sm-2">
...
{{-- Immunization History --}}
                              ...
                              <div>
                                  <button type="button" id="button" class="btn btn-default btn-custom float-right">Back</button>
                                  <button type="submit" class="btn btn-primary btn-custom float-right" id="checkBtn">Update</button>
                              </div><!-- /.col-sm-offset-3 col-sm-9 -->   
                          </form>
{{-- script --}}
                          <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                          ...
                          //Family History
                          const othersFamhis = "{{$response->othersFamhis}}";
                          const othersFamhisCheckbox = document.getElementById("othersFamhisCheckbox");
                          const othersFamhisInput = document.getElementById("othersFamhisInput");
                          ...
                          //Present Illness
                            const  othersPreIll = "{{$response-> othersPreIll}}";
                            const othersPreIllCheckbox = document.getElementById("othersPreIllCheckbox");
                            const othersPreIllInput = document.getElementById("othersPreIllInput");
                          ...
                          //Immunization History
                          const  othersImmu = "{{$response-> othersImmu}}";
                            const othersImmuCheckbox = document.getElementById("othersImmuCheckbox");
                              const othersImmuInput = document.getElementById("othersImmuInput");
                          ...
                          //Personal History
                          const sticksPerDay = "{{$response->sticksPerDay}}";
                          const forYears = "{{$response->forYears}}";
                          const smokingCheckbox = document.getElementById("smokingCheckbox");
                          const sticksPerDayInput = document.getElementById("sticksPerDayInput");
                          const forYearsInput = document.getElementById("forYearsInput");
...
// Drinking
                          ...
                          const shotPer = "{{$response->shotPer}}";
                          const beer = "{{$response->beer}}";
                          const beerPer = "{{$response->beerPer}}";
                          const drinkingCheckbox = document.getElementById("drinkingCheckbox");
                          const shotInput = document.getElementById("shotInput");
                          const shotPerInput = document.getElementById("shotPerInput");
                          const beerInput = document.getElementById("beerInput");
                          ...
                          // Enable inputs if there's data in 'shotPerDay' or 'beerPerDay' on page load
                          ...
                          // Function to enable/disable inputs based on the checkbox status
                          drinkingCheckbox.addEventListener("change", function () {
                            if (this.checked) {
                              shotInput.disabled = false;
                              shotPerInput.disabled = false;
        ...
        <div class="col-md-2">
          <div class="card">
            ...
            <div class="card-body" style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 20px;">
              <label style="font-size: 18px;" id="id">{{$response->StudentNo}}</label>
              <label style="font-size: 10px;" id="id">{{$course->SchoolLevel}}</label>
            </div>
          </div>   
          <div class="card">
            <div class="card-body" style="background-color:rgb(110, 155, 222);">
              <div class="row" >
                <div class="col-12"  style="color:#f5f2f2;font-weight:bold;font-size:12px">
                  ...
                  <hr>
                  <div class="form-group">
                    First Name: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{utf8_decode($response->FirstName)}}</label><br>
                    Middle Name: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{utf8_decode($response->MiddleName)}}</label><br>
                    Last Name: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{utf8_decode($response->LastName)}}</label><br>
                    ...
                    Religion: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{$response->religion}}</label>
                  </div>
                  <hr>
                    Contact Number: <br><label class="" id="firstname" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{$response->ContactNo}}</label>
                </div>
                {{-- <div class="col-12">
                  <div class="form-group">
