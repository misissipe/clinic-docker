    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card border">
          <div class="card-body">
            <div class="btnprint">
              <button type="button" class="btn btn-danger float-right button btnDelete" style="margin-left:1%" id="btnDelete" data-id="{{(new AESCipher)->encrypt($data->id)}}">
                <a style="color: rgb(255, 255, 255); font-size: 15px;">Delete</a>
              </button>
              <button type="button" class="btn btn-primary float-right button btnEdit" id="btnEdit" data-id="{{(new AESCipher)->encrypt($data->id)}}">
