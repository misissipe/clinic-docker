            ...
            <table class="table table-sm  cell-border zero-configuration " id="disToday">
              ...
              <tbody id="viewAllRecord">
                ...
                <tr>
                    ...
                    {{ str_contains($lastName ?? '', 'Ã') ? utf8_decode($lastName) : $lastName }},
                    {{ str_contains($firstName ?? '', 'Ã') ? utf8_decode($firstName) : $firstName }}
                    {{ str_contains($middleName ?? '', 'Ã') ? utf8_decode(substr($middleName, 0, 1)) : substr($middleName ?? '', 0, 1) }}.
