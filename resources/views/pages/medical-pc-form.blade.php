  ...
  <body>
    <header>
        <div class="header">
          ...
          <p style="font-weight: 700; font-size: 16px; font-style: bold; text-align:center;text-align:left;margin-left:4%">PROVISION OF COMFORT</p>
        </div>
    </header>
    <footer>
      <div>
        @if ( $role == 'Student')
        <img src="images/logo/SLSU-QF-MD13.png" alt="" style="width: 150px; height:50px; float-left; vertical-align: top;margin-top:5px;margin-left:50px;margin-right:200px"> <img src="images/logo/qs_star.png" alt="" style="width: 90px; height:70px; vertical-align: middle"> <img src="images/logo/socotec.png" alt="" style="width: 140px; height:55px; float: right;margin-right:300px"> </span><br>
        @elseif ($role  == 'Employee')
        <img src="images/logo/SLSU-QF-MD13-A.png" alt="" style="width: 150px; height:50px; float-left; vertical-align: top;margin-top:5px;margin-left:50px;margin-right:200px"> <img src="images/logo/qs_star.png" alt="" style="width: 90px; height:70px; vertical-align: middle"> <img src="images/logo/socotec.png" alt="" style="width: 140px; height:55px; float: right;margin-right:300px"> </span><br>
        @endif
      </div>
    </footer>
    <main>
      ...
      <div id="printPart">
       <table class="table" style="color:black;font-size:14px;width:50%">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;width:15%">ASSESSMENT AND DIAGNOSIS/ES </th>
                    <th style="text-align: center;width:15%">PLANNING AND INTERVENTION/S </th>
                </tr>
            </thead>
            <tbody>
                @forelse ($view as $data)
                    <tr>
                        ...
                        <td>{{ $data->age }}</td>
                        <td style="text-align: left;">{{ $data->Sex }}</td>
                        ...
                        <td>{{ ucwords(strtoLower($data->findings)) }}</td>
                        <td>{{ ucwords(strtoLower($data->recommendation)) }}</td>
                    </tr>
                @empty
                    <tr>
