  ...
  <body>
    <header>
        <div class="header">
          ...
          <p style="font-weight: 700; font-size: 16px; font-style: bold; text-align:center;text-align:left;margin-left:4%">OTHER CONCERN</p>
        </div>
    </header>
    <footer>
      <div>
        <img src="images/logo/other-concern.png" alt="" style="width: 150px; height:50px; float-left; vertical-align: top;margin-top:5px;margin-left:50px;margin-right:200px"> <img src="images/logo/.png" alt="" style="width: 90px; height:70px; vertical-align: middle"> <img src="images/logo/socotec.png" alt="" style="width: 140px; height:55px; float: right;margin-right:300px"> </span><br>
      </div>
    </footer>
    <main>
