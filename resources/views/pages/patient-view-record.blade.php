...
$(document).ready(function() {
    ...
    // Check if data.data is defined before using forEach
    if (data && data.data) {
        if (role === 'Student') {
              ...
              let middleName = student.MiddleName ? student.MiddleName.replace(/ï¿½\?Â±|Ã±/g, 'ñ') : '';
                table.row.add([
                    ...
                    `<td style="text-align:center">
                        <a class="dropdown-item viewPR" href="#" id="" data-id="${student.encryptedStudentNo}" data-role="${data.role}"><i class="fa fa-folder"></i></a>
                    </td>`
                ]).draw(false);
            });
            ...
            data.data.forEach(function(employee) {
              ...
              let middleName = employee.MiddleName ? employee.MiddleName.replace(/ï¿½\?Â±|Ã±/g, 'ñ') : '';
                table.row.add([
                    ...
                    `<td>${middleName}</td>`,
                    `<td style="text-align:center">
                        <a class="dropdown-item viewPR" href="#" id="" data-id="${employee.encryptedEmployeeNo}" data-role="${data.role}"><i class="fa fa-folder"></i></a>
                    </td>`
                ]).draw(false);
            });
        }
...
$(document).on('click', '.viewPR', function() {
    ...
    var role = $(this).data('role');
     ...
     if (role === 'Student'){
      window.location.href = "/patient-record?id=" + encodeURIComponent(id) + "&role=Student" ;
     } else if (role === 'Employee'){
      window.location.href = "/patient-record?id=" + encodeURIComponent(id) + "&role=Employee";
     }
});
</script>
@endsection