    ...
    <div class="col-12">
      <div class="card active">
          <div class="card-content">
              <div class="card-body">
                <label style="font-size:18px">Blood Pressure Record for the month of</label>
                <br><br>
                      ...
                      <table class="table table-sm  cell-border " id="disToday">
                        <thead>
                            <tr>
                                ...
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">BP</th>
                    ...
                    <table class="table table-sm  cell-border " id="empToday">
                      <thead>
                          <tr>
                              ...
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:20%">position/designation</th>
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:5%">BP</th>
                              {{-- <th style="color:white;text-align: center">action</th> --}}
                          </tr>
                      </thead>
                      <tbody id="viewAllRecord">
...
$(document).ready(function() {
    $('#submitToGenerate').click(function(event) {
        ...
        window.location.href = `/generate-blood-pressure?monthSearch=${monthSearch}&year=${year}&role=${role}`;
    });
});
