...
<section id="basic-datatable">
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-body">
          <button type="button" class="btn btn-primary addModal float-right" data-toggle="modal" data-id="{{$empId}}" data-target="#addMedicalDependentModal"><i class='fa fa-user-plus'> Add Dependent</i></button>
    ...
    @include('modal.addMedicalDependent')
    @include('modal.editMedicalDependent')
</div>
</section>
@endsection
{{-- vendor scripts --}}
...
$("#addModal").submit(function(e) {
    ...
    $.ajax({
        ...
        success: function(data) {
            $('#addMedicalDependentModal').modal('hide');
            Swal.fire({
                icon: 'success',
                title: 'Success!',
                text: data.success
...
console.log('hi')
    ...
    $('#addMedicalDependentModal').find('.id').val(id);
