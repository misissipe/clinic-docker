  ...
  <div class="row justify-content-center">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <button type="button" class="btn btn-primary float-right button" data-toggle="modal" data-target="#addProduct" id="addproduct"><a style="color: rgb(255, 255, 255); font-size: 15px;">Add Product</a></button>
            ...
            <table class="table table-sm recordTable table-bordered table-striped zero-configuration" id="recordTable" style="text-align:center;">
              ...
              @foreach($view as $data)  
                <tr>    
                  ...
                  <td style="text-transform:capitalize;">{{ucwords(strtoLower($data->generic_name))}}</td>
                  <td style="text-transform:capitalize;">{{ucwords(strtoLower($data->brand_name))}}</td>
