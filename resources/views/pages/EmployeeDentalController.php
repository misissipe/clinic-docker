    ...
    public function dentalChart(Request $request){
        ...
        $details = DB::table('dentalchart')->where('id', $this->aes->decrypt($request->id))->where('campus',session('campus'))->first();
            ...
            if ($details === null) {
                ...
                return view('pages.employee-dental-chart', ['pageConfigs' => $pageConfigs,'breadcrumbs' => $breadcrumbs], compact('record','dateofbirth','age','details'));
                ...
                return view('pages.employee-dental-chart', ['pageConfigs' => $pageConfigs,'breadcrumbs' => $breadcrumbs], compact('record','details','newencryptedId','details','issueDetails','age'));
            }
            return back();
