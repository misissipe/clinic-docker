<html class="loading" lang="en" data-textdirection="ltr">
  <head>
    ...
    <title>STUDENT INSURANCE LIST</title>
  ...
  <body>
    <header>
        <div class="header">
          ...
          <p style="font-weight: 700; font-size: 16px; font-style: bold; text-align:center;">STUDENT INSURANCE LIST</p>
        </div>
    </header>
    <footer>
      <div>
        ...
        <table class="table" style="color:black;font-size:14px;margin-top:3%">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;width:8%">Course & Year</th>
            ...
            <tbody>
                @forelse ($result as $data)
                    <tr>
                        ...
                        <td style="text-align: left;">{{ $data->accro }} - {{ $data->StudentYear }}</td>
                        <td style="text-align: left;">{{ ucwords(strtolower(utf8_decode($data->LastName))) }}, {{ ucwords(strtolower(utf8_decode($data->FirstName))) }} {{ ucwords(strtolower(utf8_decode(substr($data->MiddleName, 0, 1)))) }}.  </td>
