...
$(document).ready(function() {
    ...
    if (data && data.data) {
      data.data.forEach(function(patient) {
        let lastName = patient.lastname ? patient.lastname.replace(/Ã±/g, 'ñ') : '';
        let firstName = patient.firstname ? patient.firstname.replace(/Ã±/g, 'ñ') : '';
        let middleName = patient.middlename ? patient.middlename.replace(/Ã±/g, 'ñ') : '';
        table.row.add([
          ...
          `<td style="text-align:center">
              <a class="dropdown-item viewPR" href="#" id="" data-id="${patient.encryptedPatientNo}" data-role="${data.role}"><i class="fa fa-folder"></i></a>
          </td>`
          ]).draw(false);
      });
    }
...
$(document).on('click', '.viewPR', function() {
    ...
    if (role === 'Student'){
      window.location.href = "/view-OTC-Record?id=" + encodeURIComponent(id) + "&role=Student";
    } else if (role === 'Employee'){
          console.log(role);
      window.location.href = "/view-OTC-Record?id=" + encodeURIComponent(id)  + "&role=Employee";
    } else if (role === 'Dependent'){
      window.location.href = "/view-OTC-Record?id=" + encodeURIComponent(id) + "&role=Dependent";
    }
});
</script>
@endsection