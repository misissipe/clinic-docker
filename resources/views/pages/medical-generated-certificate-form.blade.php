 ...
 .cert{
  ...
  .checkbox-container {
    ...
    .textbox {
        ...
        /* Optional: Adjust width/height if necessary */
  ...
  <body>
    ...
    <footer>
      <div>
        <img src="images/logo/SLSU-QF-MD05.png" alt="" style="width: 150px; height:50px; float-left; vertical-align: top;margin-top:5px;margin-right:240px"> <img src="images/logo/qs_star.png" alt="" style="width: 80px; height:70px; vertical-align: middle"> <img src="images/logo/socotec.png" alt="" style="width: 140px; height:55px; float: right;"> </span><br>
      </div>
    </footer>
    <main>
          ...
          <td colspan="3" style="border:1px solid rgb(0, 0, 0);">
            <div style="text-align: left">
              <div style="font-weight: 400; font-size: 12px;">Name:
                <input  class="fullname cert name=" type="text" value="{{utf8_decode($response->firstname)}} {{utf8_decode($response->middlename)}} {{utf8_decode($response->lastname)}}" id="lastname" style="font-weight: 400; font-size: 12px; font-style: bold;width:100%" readonly>
              </div>
            </div>
          </td>
      ...
      <div class="form-group row col-12 input" style="color:black;">
        ...
        <span style="font-weight: 800; font-size: 12px; color: black; display: inline-block; width: 62%; text-align: center; padding-bottom: 2px; border-bottom: 1px solid black;">
          {{strtoupper($response->firstname)}} {{strtoupper($response->middlename)}} {{strtoupper($response->lastname)}}
      </span>
      ...
      <div class="form-group row col-12">
        <div style="font-weight: 700; font-size: 12px; font-style: bold; color:black;margin-bottom:5px">DIAGNOSIS:</div>
        <span style="font-weight: 400; font-size: 14px; color: black; display: inline-block; width: 100%; text-align: left; padding-bottom: 2px; border-bottom: 1px solid black;">
          {{$response->diagnosis}}
      </span>
    </div>
    
    <div class="form-group row col-12">
      <div style="font-weight: 700; font-size: 12px; font-style: bold; color: black;margin-bottom:5px">REMARKS:</div>
     ...
     @endphp
      ...
      <div class="checkbox-container">
          ...
          <span style="font-weight: 400; font-size: 12px; color: black; display: inline-block; width: 70%; text-align: left; padding-bottom: 2px; border-bottom: 1px solid black;">
            {{$response->others}}
        </span>
      </div>
      <br><br><br><br><br><br>
