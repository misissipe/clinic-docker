          ...
          <div class="card-body" style="" >
            <div class="col-sm-12">
              <div class="row col-12" style="font-size:16px;font-weight:400;">
                Name:
                  <input type="text" class=" fullname input" name=""  id=""  style="font-weight: bold;font-size:16px;width:62.6%;" value="  {{$record->firstname}} {{$record->middlename}} {{$record->lastname}}" readonly>
                DoB:
                  <input type="text" class=" col-sm-3  bday input" name=""  id="bday" style="font-weight: bold;font-size:16px;" value="{{$record->BirthDate}}" readonly>
              </div> 
              <div class="row col-12" style="font-size:16px;font-weight:400;">
                Home Address:
                  <input type="text" class=" col-sm-7  address input" name=""  id="address" style="font-weight: bold;font-size:16px;" value="" readonly>
                Age:
                  <input type="text" class=" col-sm-3  age input" name="age"  id="age" style="font-weight: bold;font-size:16px;" value={{$record->age}} readonly>
              </div>
              <div class="row col-12" style=" font-size:16px;font-weight:400;">
                Dept./Course:
                  <input type="text" class=" col-sm-7  address input" name=""  id="address" style="font-weight: bold;font-size:16px;" value="{{$record->role}}" readonly>&nbsp;
                Gender:
                  <input type="text" class=" col-sm-1  age input" name="gender"  id="age" style="font-weight: bold;font-size:16px;" value={{$record->gender}} readonly>
                Date:
        ...
        <div class="card border">
          <div class="card-body" >
            <h4 style="font-weight:700;text-align: center">DENTAL RECORD CHART</h4>
              ...
              @csrf
                <input type="hidden" class=" col-sm-1 input " name="role"  id="role" style="" value="Dependent" >
                ...
                <input type="hidden" class=" cert col-sm-2 border-0 fullname " name="BirthDate"  id="BirthDate" style="" value="{{$record->BirthDate}} " readonly>
                ...
                <input type="hidden" class=" col-sm-3  age input" name="age"  id="age" style="font-weight: bold;font-size:16px;" value={{$record->age}} readonly>
                ...
                {{-- <input type="hidden" class="  border-0  date" name="date"  id="date" style="width:34%" value="" readonly> --}}
            ...
            <div class="col-sm-12">
                <div class="row col-12" style="font-size:16px;font-weight:400;">
                  Name:
                    <input type="text" class=" fullname input" name=""  id=""  style="font-weight: bold;font-size:16px;width:62.6%;" value="  {{$record->firstname}} {{$record->middlename}} {{$record->lastname}}" readonly>
                  DoB:
                    <input type="text" class=" col-sm-3  bday input" name=""  id="bday" style="font-weight: bold;font-size:16px;" value="" readonly>
                </div> 
                <div class="row col-12" style="font-size:16px;font-weight:400;">
                  Home Address:
                    <input type="text" class=" col-sm-7  address input" name=""  id="address" style="font-weight: bold;font-size:16px;" value="" readonly>
