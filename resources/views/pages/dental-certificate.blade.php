...
{{-- title --}}
@section('title','Dental Certficate')
            ...
            <form  action="/patient-information" method="post" id="submitBtn">
              <div style="display:flex; justify-content:space-between;">
                ...
                <div class="input-group mb-1" style="width: fit-content;">
                  <input class="form-control @error('searchInput') is-invalid @enderror" required type="text" placeholder="Search" id="searchInput" autocomplete="off">
...
$(document).on('click', '.add', function(){
  ...
  if (role === 'Student') {
      console.log(id);
      window.location.href = "/dental-certificate-patient-information?id=" + encodeURIComponent(id) + "&role=Student";
  } else if (role === 'Employee') {
      window.location.href = "/dental-certificate-patient-information?id=" + encodeURIComponent(id) + "&role=Employee";
  }
});
 ...
 $(document).on('click', '.view', function(){
  ...
  if (role === 'Student') {
    window.location.href = "/dental-view-certificate?id=" + encodeURIComponent(id) + "&role=Student";
  } else if (role === 'Employee') {
    window.location.href = "/dental-view-certificate?id=" + encodeURIComponent(id) + "&role=Employee";
  }
});
</script>
@endsection