    ...
    <div class="col-md-10">
      <div class="row">
        <div class="col-md-12">
          <div class="card border">
            <div class="card-header border " style="background-color:rgb(110, 155, 222);color:#ffffff;height:50px;font-size:15px;font-weight:800; display: flex; align-items: center;"><i class="fas fa-file-alt" style='font-size:15px'></i> PATIENT RECORDS</div>
              <div class="card-body mt-0 p-1">
                <div class="table-responsive" >
                  <table class="table myTable table-bordered table-striped zero-configuration" id="myTable" style="width:100%">
                    <thead>
                      <tr>
                    ...
                    <tbody id="viewStatus">  
                      @foreach ($status as $data)
                        <tr>    
                          ...
                          <td> @if (strpos($data->cert_issued, 'Others') !== false)
                                {{ $data->others }}
                              @else
                                {{ implode(', ', json_decode($data->cert_issued)) }}
                              @endif
                          </td>
                          ...
                          <td>
                            <button type="button" class="btn btn-default print" data-id="{{$newencryptedId}}" @if($data->status == 'Pending' || $data->status == 'Disapproved') disabled @endif><i class="fa fa-print"></i></button>
                          </td>           
                        </tr>
                      @endforeach
                    </tbody>
      ...
      <div class="col-md-10">
        <div class="row">
          <div class="col-md-12">
            <div class="card border">
              <div class="card-header border " style="background-color:rgb(110, 155, 222);color:#ffffff;height:50px;font-size:15px;font-weight:800;"><i class="fas fa-file-alt" style='font-size:15px'></i> PATIENT RECORDS</div>
                <div class="card-body mt-0 p-1">
                      <div class="table-responsive" >
                        <table class="table myTable table-bordered table-striped zero-configuration" id="myTable" style="width:100%">
                          <thead>
