            ...
            <div style="display: flex; justify-content: space-between; font-weight: 600; font-size: 20px;">
              <div style="text-align: left; flex: 1;">
                  ...
                  <div style="flex-direction: column;">
                      <input name="" type="text" value="{{$preparedby->FirstName ?? 'please input signatories'}} {{$preparedby->MiddleName ?? ''}} {{$preparedby->LastName ?? ''}} "  placeholder="please input signatories" style="text-decoration:underline;text-decoration-thickness: 1px;"><br>
                      <input name="" type="text" value="{{$preparedby->EmploymentStatus ?? ''}}, Dental Assistant" placeholder="please input signatories">
              ...
              <div style=" flex: 1;">
                  Noted by: <br><br><br>
                  <div style="flex-direction: column;">
                      <input name="" type="text" value="{{$noted->FirstName ?? 'please input signatories'}} {{$noted->MiddleName ?? ''}} {{$noted->LastName ?? ''}}" style="text-decoration:underline;text-decoration-thickness: 1px;" placeholder="please input signatories"><br>
                      <input name="" type="text" value="{{$noted->Designation ?? ''}}, {{$noted->Office ?? ''}}" placeholder="please input signatories">
                      <div style="margin-top: 20px;">
                          <input name="" type="text" value="">
                          <span style="margin-left: auto;"></span>
                          <input name="" type="text" value="">
