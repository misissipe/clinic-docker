          ...
          <div class="card-body">
            <div class="table-responsive">
              ...
              <form  action="/saveReferral" method="post" id="saveRefer">
               @csrf
                <input  class="form-control id col-2" type="hidden" name="patientId" value="{{$id}}" id="id" >
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control course" value="{{$view->ContactNo ?? $view->Cellphone}}" name="ContactNo" id="course" readonly>
                        </div>
                       </div>
                      <div class="col-sm-4">
                        <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="date" class="form-control bday" value="{{$newbday ?? $dateofbirth}}" name="bday" id="bday" readonly>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label for="address">Civil Status</label>
                        <input type="text" class="form-control civil_stat" value="{{$view->civil_status ?? $view->CivilStatus}}" name="civil_stat" id="civil_stat" readonly>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                        <label for="address">Nationality</label>
                        <input type="text" class="form-control nationality" value="{{ $view->nationality ?? $view->citizenship ?? '' }}" name="nationality" id="nationality" readonly>
                      </div>
                    </div>
                    <div class="col-sm-3">
                      <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control brgy capitalize" value="{{ ucwords(strtolower($view->RBarangay ?? $view->brgy))}}" name="brgy" required id="brgy-input" readonly>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label for="address">City</label>
                          <input type="text" class="form-control city capitalize" value="{{ ucwords(strtolower($view->citymunDesc ?? $view->city))}}" name="city" required id="city-input" readonly>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label for="address">Province</label>
                          <input type="text" class="form-control province capitalize" vvalue="{{ ucwords(strtolower($view->provDesc ?? $view->province))}}" name="province" required id="province" readonly>
                        </div>
                      </div>
                    </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-sm-2">
                      <div class="form-group">
                        ...
                        <input type="text " class="form-control bday" value="{{$mr->height ?? ''}}" name="height" id="bday" readonly>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="form-group">
                        <label for="address">Weight:</label>
                        <input type="text" class="form-control civil_stat" value="{{$mr->weight ?? ''}}" name="weight" id="civil_stat" readonly>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="form-group">
                        <label for="address">Temp:</label>
                        <input type="text" class="form-control nationality" value="{{$mr->temp ?? ''}}" name="temp" id="nationality" readonly>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="form-group">
                        <label for="address">PR:</label>
                        <input type="text" class="form-control religion" value="{{$mr->pulse ?? ''}}" name="pr" id="religion" readonly>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="form-group">
                        <label for="address">RR:</label>
                        <input type="text" class="form-control religion" value="{{$mr->res_rate ?? ''}}" name="rr" id="religion" readonly>
                      </div>
                    </div>
                    <div class="col-sm-2">
                      <div class="form-group">
                        <label for="address">BP:</label>
                        <input type="text" class="form-control religion" value="{{$mr->bp ?? ''}}" name="bp" id="religion" readonly>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-sm-12">
                  <div style="font-weight: 700; font-size: 15px;font-style: bold;">CHIEF COMPLAINT/S:<span class="text-danger">*</span></div>
                    <input type="text" class="form-control @error('findings') is-invalid @enderror" name="complaint" value="{{ $mr->findings ?? ''}}" required autocomplete="findings" id="findings" style="text-transform:capitalize" readonly>
                </div>
                <div class="col-sm-12">
                  <div style="font-weight: 700; font-size: 15px;font-style: bold;">ACTION TAKEN:<span class="text-danger">*</span></div>
                   <input type="text" class="form-control @error('reco') is-invalid @enderror" name="action_taken" value="{{ $mr->recommendation ?? ''}}" required autocomplete="reco" id="reco" style="text-transform:capitalize" readonly> 
                  </div>
                <div class="col-sm-12">
