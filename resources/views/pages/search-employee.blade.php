        ...
        function updateTable(data) {
          ...
          table.row.add([
              ...
              `<td style="text-align:center">
                  <a class="dropdown-item history" href="#" id="" data-id="${employee.encryptedEmployeeNo}"><i class="fa fa-folder"></i></a>
              </td>`
          ]).draw(false);
      });
...
$(document).on('click', '.history', function(){
  var id = $(this).data('id');
  window.location.href = "/information-employee?id=" + encodeURIComponent(id);
