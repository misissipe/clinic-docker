                  ...
                  <div class="tab-pane active" id="home" aria-labelledby="home-tab" role="tabpanel">
                    <div class="table-responsive view-all active" id="todayDisapprove">
                      ...
                      <table class="table table-sm  cell-border " id="disToday">
                        <thead>
                            <tr>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:8%">date/time</th>
                                {{-- <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:8%">id number</th> --}}
                                ...
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:7%">course & year level</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:10%">ASSESSMENT AND DIAGNOSIS/ES</th>
                        ...
                        <tbody id="viewAllRecord">
                          ...
                          @endphp
                            <tr>
                                ...
                                <td style="text-align: left;">{!! implode('<br>', $items) !!}</td> 
                        ...
                        <input type="hidden"name="firstname" id="roleSelect" value="Employee">
                          <thead>
                              <tr>
                                ...
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:30%">name</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:5%">age</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:5%">sex</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:7%">position/course & year level</th>
                    ...
                    <div class="table-responsive view-all">
                      <div id="printPart">
                        ...
                        <table class="table table-sm recordTable cell-border" id="print">
                          ...
                          <thead>
                              <tr>
                                  <th style="color:rgb(0, 0, 0); text-align: center; border: 1px solid rgb(0, 0, 0);width:10%">date/timr</th>
                                  {{-- <th style="color:rgb(0, 0, 0); text-align: center; border: 1px solid rgb(0, 0, 0);width:7%">id number</th> --}}
                                  <th style="color:rgb(0, 0, 0); text-align: center; border: 1px solid rgb(0, 0, 0);width:30%">Name</th>
                                  ...
                                  <th style="color:rgb(0, 0, 0); text-align: center; border: 1px solid rgb(0, 0, 0);width:15%">position/designation /course & year level</th>
            ...
            if (data.length > 0) {
                $.each(data, function(index, record) {
                  ...
                  var newTimeStr = hours + ':' + minutes + ' ' + period;
                    ...
                    var pcs = record.OTCmedpcs ? JSON.parse(record.OTCmedpcs) : [];
                    var desc = record.OTCmedDescript ? JSON.parse(record.OTCmedDescript) : [];
                    var otcMedItems = [];

                    for (var i = 0; i < pcs.length; i++) {
                        if (pcs[i] && desc[i]) {
                            otcMedItems.push(pcs[i] + ' ' + desc[i].toLowerCase().replace(/\b\w/g, c => c.toUpperCase()));
                        }
                    }

                    var otcMedDesc = otcMedItems.join('<br>');
