...
{{-- title --}}
@section('title','Provision of Comfort')
    ...
    <div class="col-12">
      <div class="card active">
          <div class="card-content">
              <div class="card-body">
                <label style="font-size:18px">Provision Of Comfort Record for the month of</label>
                <br><br>
                ...
                <div class="tab-content">
                      ...
                      <table class="table table-sm  cell-border " id="disToday">
                        <thead>
                            <tr>
                              ...
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:10%">name</th>
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:3%">age</th>
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:3%">sex</th>
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:10%">course & year level</th>
                    ...
                    <table class="table table-sm  cell-border " id="empToday">
                      <thead>
                          <tr>
                            ...
                            <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:3%">age</th>
                            <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:3%">sex</th>
                            <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:10%">position/designation</th>
                            <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:15%">ASSESSMENT AND DIAGNOSIS/ES </th>
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:15%">PLANNING AND INTERVENTION/S </th>
                              {{-- <th style="color:white;text-align: center">action</th> --}}
                          </tr>
                  ...
                  <div class="tab-pane" id="profile" aria-labelledby="profile-tab" role="tabpanel">
                    <div class="table-responsive view-all">
                      <div class="btnprint">
                        <form action="/generate-provision-of-comfort" method="get" target="_blank" class="float-right">
                          <button type="submit" class="btn btn-primary" id="submitToGenerate" style="font-size: 15px; color: rgb(255, 255, 255);">
                              Print
                          </button>
                      </form>
                      </div>
                      <form action="/medical-provision-of-comfort" method="post" id="submitBtn">
                        @csrf
                        ...
                        <input type="hidden"name="firstname" id="roleSelect" value="Employee">
                          <thead>
                              <tr>
                                ...
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:3%">age</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:3%">sex</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:10%">position/course & year level</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:15%">ASSESSMENT AND DIAGNOSIS/ES </th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:15%">PLANNING AND INTERVENTION/S </th>
                              </tr>
                          </thead>
...
$(document).ready(function() {
    ...
    $('#submitBtn').submit(function(event) {
        ...
        $.ajax({
            url: '/medical-provision-of-comfort', 
            type: 'POST',
            data: {
...
$(document).ready(function() {
    $('#submitToGenerate').click(function(event) {
        ...
        window.location.href = `/generate-provision-of-comfort?monthSearch=${monthSearch}&year=${year}&role=${role}`;
    });
});
 $(document).ready(function(){
