...
{{-- title --}}
@section('title','Tooth Extraction')
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="profile" aria-labelledby="profile-tab" role="tabpanel">
                <div class="table-responsive view-all">
                  ...
                  <form action="/records-of-toothextractio" method="post" id="submitBtn">
                    @csrf
                  ...
                  <table class="table table-sm recordTable  cell-border " id="preView">
                    ...
                    <thead>
                      <tr>
                          ...
                          <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">Position/Course</th>
                  ...
                  <table class="table table-sm recordTable cell-border" id="print">
                    ...
                    <thead>
                      <tr>
                          ...
                          <th style="color:rgb(0, 0, 0); text-align: center; border: 1px solid rgb(226, 222, 222);">name of patient</th>
                          ...
                          <th style="color:rgb(0, 0, 0); text-align: center; border: 1px solid rgb(226, 222, 222);">Position/Course</th>
                          <th style="color:rgb(0, 0, 0); text-align: center; border: 1px solid rgb(226, 222, 222);r">diagnosis</th>
                          {{-- <th style="color:rgb(0, 0, 0); text-align: center; border: 1px solid rgb(226, 222, 222);">or number</th> --}}
                      </tr>
                  </thead>
                    <tbody>
...
if (data.length > 0) {
    $.each(data, function (index, record) {
        ...
        var newRow = '<tr class="tr">' +
            ...
            '<td class="border">' + record.diagnosis + '</td>' +
            '</tr>';
