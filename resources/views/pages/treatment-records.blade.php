...
<section id="basic-datatable">
  <div class="row">
    ...
    @include('modal.editTreatmentRecord')
  </div>
</section>
@endsection
{{-- vendor scripts --}}
...
//Search Input
 $(document).ready(function() {
  ...
  // Assuming you have a 'data' variable containing the JSON response
    if (data) {
      data.data.forEach(function(patient) {
          let lastName = patient.lastname ? patient.lastname.replace(/ï¿½\?Â±|Ã±/g, 'ñ') : '';
          let firstName = patient.firstname ? patient.firstname.replace(/ï¿½\?Â±|Ã±/g, 'ñ') : '';
          let middleName = patient.middlename ? patient.middlename.replace(/ï¿½\?Â±|Ã±/g, 'ñ') : '';
          table.row.add([
...
$(document).on('click', '.viewPR', function() {
    ...
    window.location.href = "/treatment-record-list?id=" + encodeURIComponent(id) + "&role=" + role;
});
