...
<section id="basic-datatable">
  <div class="row">
    <div class="col-12">
      <div class="card">
        {{-- <div class="card-header" style="font-weight: bold; font-style: italic; color: white; background-color: rgb(110, 155, 222); height: 50px; display: flex; align-items: center;">RECORDS</div> --}}
          <div class ="card-body">
            <form  action="/add-patient" method="post" id="submitBtn">
              <div style="display:flex; justify-content:space-between;">
                ...
                <div class="input-group mb-1" style="width: fit-content;">
                  <input class="form-control" type="text" placeholder="Search" id="searchInput" autocomplete="off" required>
            ...
            `<td style="text-align:center"
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" >
                  ...
                  <a class="dropdown-item view" data-role="Student" href="#" data-id="${student.encryptedStudentNo}" ><i class="bx bx-folder mr-1"></i> record</a>
                </div>
              </div>
            </td>`
        ]).draw(false);
...
$(document).on('click', '.add', function(){
  ...
  if (role === 'Student') {
    ...
    if (result.isConfirmed) {
      window.location.href = "/referral-patient-information?id=" + encodeURIComponent(id) + "&role=Student";
    }
  });
    ...
    if (result.isConfirmed) {
      window.location.href = "/referral-patient-information?id=" + encodeURIComponent(id) + "&role=Employee";
    }
  });
...
//List
 $(document).on('click', '.view', function(){
  ...
  if (role === 'Student') {
      window.location.href = "/referral-view-record?id=" + encodeURIComponent(id) + "&role=Student";
  } else if (role === 'Employee') {
    window.location.href = "/referral-view-record?id=" + encodeURIComponent(id) + "&role=Employee";
  }
 });
