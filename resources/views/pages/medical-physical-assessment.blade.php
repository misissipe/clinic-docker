    ...
    <div class="col-12">
      <div class="card active">
          <div class="card-content">
              <div class="card-body">
                <label style="font-size:18px">Physical Assessment Record for the month of</label>
                <br><br>
                ...
                <div class="tab-content">
                      ...
                      <table class="table table-sm  cell-border " id="disToday">
                        <thead>
                            <tr>
                                ...
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:10px">course & year level</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">ASSESSMENT AND DIAGNOSIS/ES </th>
                    ...
                    <table class="table table-sm  cell-border " id="empToday">
                      <thead>
                          <tr>
                                ...
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">age</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">sex</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:10px">position/designation</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">ASSESSMENT AND DIAGNOSIS/ES </th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">PLANNING AND INTERVENTION/S </th>
                              {{-- <th style="color:white;text-align: center">action</th> --}}
                          </tr>
                  ...
                  <div class="tab-pane" id="profile" aria-labelledby="profile-tab" role="tabpanel">
                    <div class="table-responsive view-all">
                      <div class="btnprint"> 
                        {{-- <form action="/generate-wound-dressing" method="get" target="_blank" class="float-right">
                        ...
                        <input type="hidden"name="firstname" id="roleSelect" value="Employee">
                          <thead>
                              <tr>
                                ...
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:15%">name</th>
                                ...
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:16%">ASSESSMENT AND DIAGNOSIS/ES </th>
...
$(document).ready(function() {
    ...
    $('#submitBtn').submit(function(event) {
        ...
        $.ajax({
            url: '/medical-physical-assessment', 
            type: 'POST',
            data: {
...
$(document).ready(function() {
    $('#submitToGenerate').click(function(event) {
        ...
        window.location.href = `/generate-wound-dressing?monthSearch=${monthSearch}&year=${year}&role=${role}`;
    });
});
