...
{{-- title --}}
@section('title','Issuance of Slip')
    ...
    <div class="col-12">
      <div class="card active">
          <div class="card-content">
              <div class="card-body">
                <label style="font-size:18px">Issuance of Slip Record for the month of</label>
                <br><br>
                  ...
                  <div class="tab-content">
                        ...
                        <table class="table table-sm  cell-border " id="disToday">
                          <thead>
                              <tr>
                                ...
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">assesment and diagnosis/es</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">planning and intervention/s</th>
                                <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">referred to</th>
                      ...
                      <table class="table table-sm  cell-border " id="empToday">
                        <thead>
                            <tr>
                              ...
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">age</th>
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">sex</th>
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);width:20px">position</th>
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">assesment and diagnosis/es</th>
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">planning and intervention/s</th>
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">referred to</th>
                              <th style="color:white;text-align: center;border: 1px solid rgb(226, 222, 222);">remarks</th>
                    ...
                    <div class="tab-pane" id="profile" aria-labelledby="profile-tab" role="tabpanel">
                      <div class="table-responsive view-all">
                        <div class="btnprint">
                          <form action="/generate-issuance-of-slip" method="get" target="_blank" class="float-right">
                    ...
                    <div class="tab-pane" id="printMe" aria-labelledby="print-tab" role="tabpanel">
                      <div class="table-responsive view-all">
                        <div id="printPart">
                          ...
                          <div class="row">
                            <div class="col-lg-12 d-flex justify-content-center" style="font-weight: 700; font-size: 17px; font-style: bold; text-align:center;color:black;">LOGBOOK (ISSUANCE OF REFERRAL SLIP)</div>
                          </div><br><br>
                          <table class="table table-sm recordTable cell-border" id="print">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th style="color:rgb(0, 0, 0); text-align: center; border: 1px solid rgb(0, 0, 0); width:20%">position/designation /course & year level</th>
                                    <th style="color:rgb(0, 0, 0); text-align: center; border: 1px solid rgb(0, 0, 0);">findings</th>
                                </tr>
                            </thead>
                            <tbody>
...
$(document).ready(function() {
    $('#submitToGenerate').click(function(event) {
        ...
        window.location.href = `/generate-issuance-of-slip?monthSearch=${monthSearch}&year=${year}&role=${role}`;
    });
});
