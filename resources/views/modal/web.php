...
#Appointment
Route::middleware(['authuser'])->group(function () {
    Route::get('/appointment','appointmentMedicalController@index');
    Route::post('/searchInfo', 'appointmentMedicalController@autocompleteInfo')->name('autocompleteInfo');
    Route::get('/set-schedule','appointmentMedicalController@setSched');
    Route::post('/setAppointmemt','appointmentMedicalController@create');
    Route::get('/view-appointment','appointmentMedicalController@view');
    Route::post('/setStatus','appointmentMedicalController@ResultStatus');
    Route::get('/view-status-appointment','appointmentMedicalController@status');
    Route::post('/reschedule','appointmentMedicalController@reschedule');
    Route::get('/payment-appointment','appointmentMedicalController@paymentappointment');
    Route::post('/viewModalPayment','appointmentMedicalController@viewModalPayment');
    Route::post('/rescheduleModal','appointmentMedicalController@reScheduled');
    Route::post('/payment','appointmentMedicalController@payment');
});
...
Route::middleware(['authuser'])->group(function () {
    ...
    Route::get('/medical-and-social-health-history','MedClientAddController@healthHistory');
...
Route::middleware(['authuser'])->group(function () {
    ...
    //for create
    Route::get('/referral-patient-information','ReferralController@referalPatientInfo');
    //for approvalstar
...
Route::middleware(['authuser'])->group(function () {
    ...
    Route::post('/update-treatment-record','DentalClientAddController@updateModal');
...
Route::middleware(['authuser'])->group(function () {
    ...
    Route::get('/patient-OTC-record','OTCMedController@OTCRecordindex');
...
Route::middleware(['authuser'])->group(function () {
    ...
    Route::post('/t', 'StocksController@deleteLabResult');
});
