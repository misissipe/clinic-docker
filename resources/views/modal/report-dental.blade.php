            ...
            <div style="display: flex; justify-content: space-between; font-weight: 600; font-size: 20px;">
              <div style="text-align: left; flex: 1;">
                  ...
                  <div style="flex-direction: column;">
                      <input name="" type="text" value="MARCEL G. PACAT" style="text-decoration:underline;text-decoration-thickness: 1px;"><br>
                      <input name="" type="text" value="Attendant, Job Order">
              ...
              <div style=" flex: 1;">
                  Noted by: <br><br><br>
                  <div style="flex-direction: column;">
                      <input name="" type="text" value="GRETTA D. GUIROY, DDM" style="text-decoration:underline;text-decoration-thickness: 1px;"><br>
                      <input name="" type="text" value="Dentist, Director Health Services">
                      <div style="margin-top: 20px;">
                          <input name="" type="text" value="">
                          <span style="margin-left: auto;"></span>
                          <input name="" type="text" value="">
