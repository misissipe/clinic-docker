...
<div id="addSignatories" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-weight: bold; color: white;" class='col-12 modal-title move'>Add Signatories</h5>
            </div>
            <form action="/addSignatories" method="POST" id="addSignatoriesModal">
                @csrf
                <div class="modal-body">       
                    <div class="form-group">
                        ...
                        <label for="title">Designation</label><span style="font-size:12px"> (for dental services only)</span>
                        ...
                        <select name="emp" class="form-control w-50 services" id="sy-select">
                            <option value="" disabled="disabled">-Select-</option>
                            <?php
