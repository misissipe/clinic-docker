...
<!-- Editing form modal -->
    <div id="addDependentModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 style="font-weight: bold;color:white;height:10px">ADD DEPENDENT</h5>
                </div>
                <div class="modal-body">             
                <form action="/addnewDependent" method="POST" id="addModal"> 
                    @csrf
                        <div id="dataStudent" >
