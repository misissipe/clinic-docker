  ...
  <body>
    <header>
        <div class="header">
          ...
          <p style="font-weight: 700; font-size: 16px; font-style: bold; text-align:center;">Students and Auxiliary Services</p>
          <p style="font-weight: 700; font-size: 16px; font-style: bold; text-align:center;text-align:left;margin-left:4%">ISSUANCE OF REFERRAL SLIP</p>
        </div>
    </header>
    <footer>
      <div>
         <img src="images/logo/SLSU-QF-MD10.png" alt="" style="width: 150px; height:50px; float-left; vertical-align: top;margin-top:5px;margin-left:100px;margin-right:150px"> <img src="images/logo/qs_star.png" alt="" style="width: 90px; height:70px; vertical-align: middle"> <img src="images/logo/socotec.png" alt="" style="width: 140px; height:55px; float: right;margin-right:150px"> </span><br>
      </div>
    </footer>
    <main>
   
      <div id="printPart">
        <table class="table" style="color:black;font-size:14px;margin-top:3%">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;width:5%">@if ( $role == 'Student')COURSE & YEAR LEVEL @elseif ($role  == 'Employee')POSITION @endif</th>
                    <th style="text-align: center;width:14%">ASSESSMENT AND DIAGNOSIS/ES </th>
                    <th style="text-align: center;width:14%">PLANNING AND INTERVENTION/S </th>
                    <th style="text-align: center;width:10%">REFERRED TO </th>
            ...
            <tbody>
                @forelse ($view as $data)
                    <tr>
                        ...
                        <td style="text-align: left;">{{ $data->referTo }}</td>
