  ...
  <body>
    <header>
        <div class="header">
          ...
          <p style="font-weight: 700; font-size: 16px; font-style: bold; text-align:center;text-align:left;margin-left:4%">BLOOD PRESSURE (BP)</p>
        </div>
    </header>
    <footer>
      <div>
         @if ( $role == 'Student')
        <img src="images/logo/SLSU-QF-MD11.png" alt="" style="width: 150px; height:50px; float-left; vertical-align: top;margin-top:5px;margin-left:100px;margin-right:150px"> <img src="images/logo/qs_star.png" alt="" style="width: 90px; height:70px; vertical-align: middle"> <img src="images/logo/socotec.png" alt="" style="width: 140px; height:55px; float: right;margin-right:150px"> </span><br>
        @elseif ($role  == 'Employee')
        <img src="images/logo/SLSU-QF-MD11-A.png" alt="" style="width: 150px; height:50px; float-left; vertical-align: top;margin-top:5px;margin-left:100px;margin-right:150px"> <img src="images/logo/qs_star.png" alt="" style="width: 90px; height:70px; vertical-align: middle"> <img src="images/logo/socotec.png" alt="" style="width: 140px; height:55px; float: right;margin-right:150px"> </span><br>
        @endif
      </div>
    </footer>
    <main>
   
      <div class="row" id="printPart">
        <table class="table" style="color:black;font-size:14px;width:50%">
            <thead>
                <tr>
                  ...
                  <th style="text-align: center;width:5%">SEX</th>
                  <th style="text-align: center;width:10%">@if ( $role == 'Student')COURSE & YEAR LEVEL @elseif ($role  == 'Employee')POSITION/DESIGNATION @endif</th>
                  <th style="text-align: center;width:10%">BP</th>
                </tr>
            </thead>
            <tbody>
                    ...
                    <tr>
                      <td style="text-align: center;">{{ date('m-d-Y', strtotime($data->date)) }} / {{ date('h:i A', strtotime($data->time)) }}</td>
                       ...
                       <td style="text-align: left;">
                            @if ($data->role === 'Student' && isset($data->accro, $data->StudentYear))
                                {{ $data->accro }} - {{ $data->StudentYear }}
                            @elseif ($data->role === 'Employee' && isset($data->EmploymentStatus))
                                {{ $data->EmploymentStatus }}
                            @endif
                        </td>

                        <td style="text-align: left;">{{ $data->bp}}</td>
                    </tr>
                @empty
                    <tr>
