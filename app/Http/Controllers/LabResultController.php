...
class LabResultController extends Controller
{
    ...
    public function uploadFiles(Request $request){
        try {
            ...
            $storedFileNames = []; // To keep track of final stored names
...
foreach ($files as $key => $file) {
    if ($file) {
        ...
        while (\Storage::exists($filePath) || in_array($fileName, $storedFileNames)) {
        ...
        $storedFileNames[$key] = $fileName; // Store final filename for DB
    } else {
        $storedFileNames[$key] = null;
    }
}

// Insert into database using final stored filenames
$storeFile = LabResult::insert([
    'patientId' => $request->patientId,
    'file_cbc' => $storedFileNames['file_cbc'],
    'file_urinalysis' => $storedFileNames['file_urinalysis'],
    'file_xray' => $storedFileNames['file_xray'],
    'file_ecg' => $storedFileNames['file_ecg'],
    'file_drug_test' => $storedFileNames['file_drug_test'],
    'file_others' => $storedFileNames['file_others'],
