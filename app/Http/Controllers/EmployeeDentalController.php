...
class EmployeeDentalController extends Controller
{
    ...
    public function dentalChart(Request $request){
        ...
        $result =DB::connection('hrmis')
            ...
            ->where('campus',session('campus'))->first();
        ...
        $details = DB::table('dentalchart')->where('id', $this->aes->decrypt($request->id))->where('campus',session('campus'))->first();
            ...
            if ($details === null) {
                ...
                return view('pages.employee-dental-chart', ['pageConfigs' => $pageConfigs,'breadcrumbs' => $breadcrumbs], compact('record','dateofbirth','age','details','result'));
                ...
                return view('pages.employee-dental-chart', ['pageConfigs' => $pageConfigs,'breadcrumbs' => $breadcrumbs], compact('record','details','newencryptedId','details','issueDetails','age','result'));
            }
            return back();
    ...
    public function create(Request $request){
        ...
        $found = DB::table('dentalchart')->where('id',$patientId)->where('campus',session('campus'))->first();
        if ($found) {
            ...
            DB::table('appointment')
             ...
             $newId = DB::table('dentalchart')->where('id', $request->id)->latest('id')->where('campus', session('campus'))->first();
