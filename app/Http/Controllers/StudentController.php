...
class StudentController extends Controller
{
    ...
    public function modalPersonal(Request $request){
      $student = Student::where('StudentNo',$this->aes->decrypt($request->id))
                ->where('campus', session('campus'))
                ->first();
  ...
  public function indexGenerate(){
    ...
    $courseList = [
        1 => ['BEED', 'BSCrim', 'BSCE', 'BSComPE', 'BSFT', 'BSHRTM', 'BSHM', 'BSInfoTech', 'BSIT', 'BSME', 'BSEE', 'BSTM', 'BTLEd', 'BIT','BIndTech', 'MAT', 'MM', 'MTE', 'MSIT', 'PhD-TM','ROTC-CE-BIST','ROTC-CE-STAC'],
        2 => ['BSA', 'BSSW', 'BST'],
