  ...
  <body>
    <header>
        <div class="header">
          ...
          <p style="font-weight: 700; font-size: 16px; font-style: bold; text-align:center;text-align:left;margin-left:4%">OVER-THE-COUNTER MEDICINE</p>
        </div>
    </header>
    <footer>
      <div>
         <img src="images/logo/SLSU-QF-MD08.png" alt="" style="width: 150px; height:50px; float-left; vertical-align: top;margin-top:5px;margin-left:100px;margin-right:150px"> <img src="images/logo/qs_star.png" alt="" style="width: 90px; height:70px; vertical-align: middle"> <img src="images/logo/socotec.png" alt="" style="width: 140px; height:55px; float: right;margin-right:150px"> </span><br>
      </div>
    </footer>
    <main>
        ...
        <table class="table" style="color:black;font-size:14px;">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;width:18%">ASSESSMENT AND DIAGNOSIS/ES</th>
                    <th style="text-align: center;width:18%">PLANNING AND INTERVENTION/S </th>
                    <th style="text-align: center;width:18%">MEDICINE/S  </th>
                </tr>
            </thead>
            <tbody>
