                      ...
                      <div id="printPart">
                        ...
                        <div class="row">
                          <div class="col-lg-12 d-flex align-items-center" style="font-weight: 700; font-size: 22px; color: black;">
                            <div style="position: absolute; left: 50%; transform: translateX(-50%);">
                              ...
                              <div style="font-weight: 400; font-size: 14px; color: black;">Course:
                                <input class="col-4 course cert" name="" type="text" value="{{$course->accro}}" id="fullname" style="font-weight: 400; font-size: 16px; font-style: bold;">
                              </div>
                              <div style="font-weight: 400; font-size: 14px; color: black;">School Year:
                                <input class="col-4 cert" name="" type="text" value="{{$addYear}}" id="fullname" style="font-weight: 400; font-size: 16px; font-style: bold;">
                              </div>
                            </div>
                          ...
                          <div class=" col-md-12" style="color: #000000">
                            ...
                            Gender: <input  class="gender cert" name="" type="text" value="{{$gender}}" id="gender" style="width:11%;font-weight: 400; font-size: 16px; font-style: bold;text-align:center">
                          </div>
                          ...
                          <div class="col-md-12" style="color: #000000">
                            Date of Birth: <input  class="bday cert" name="" type="text" value="{{$course->BirthDate}}" id="bday" style="width:20%;font-weight: 400; font-size: 16px; font-style: bold;text-align:center">
                            ...
                            Nationality: <input  class="nationality cert" name="" type="text" value="{{$course->nationality}}" id="nationality" style="width:15%;font-weight: 400; font-size: 16px; font-style: bold;text-align:center">
                            Religion: <input  class="religion cert" name="" type="text" value="{{$course->religion}}" id="religion" style="width:20%;font-weight: 400; font-size: 16px; font-style: bold;text-align:center">
                          </div>
                          <div class="col-md-12" style="color: #000000">
                            Home Address: <input  class="fullname cert" name="" type="text" value="{{$course->p_street}}, {{$course->p_municipality}} {{$course->p_province}}" id="fullname" style="width:90.4%;font-weight: 400; font-size: 16px; font-style: bold;text-transform:capitalize;">
                          </div>
                          <div class="col-md-12" style="color: #000000">
                            Father's Name: <input  class="father_name cert" name="" type="text" value="{{$course->father_name}}" id="father_name" style="width:40.2%;font-weight: 400; font-size: 16px; font-style: bold;">
                            Mother's Name: <input  class="mother_name cert" name="" type="text" value="{{$course->mother_name}}" id="mother_name" style="width:39.6%;font-weight: 400; font-size: 16px; font-style: bold;">
                          </div>
                          <div class="col-md-12" style="color: #000000">
                            Occupation: <input  class="father_occu cert" name="" type="text" value="{{$course->father_occu}}" id="father_occu" style="width:42%;font-weight: 400; font-size: 16px; font-style: bold;">
                            Occupation: <input  class="mother_occu cert" name="" type="text" value="{{$course->mother_occu}}" id="mother_occu" style="width:42%;font-weight: 400; font-size: 16px; font-style: bold;">
                          </div>
                          <div class="col-md-12" style="color: #000000">
                            Office Address: <input  class="fullname cert" name="" type="text" value="" id="fullname" style="width:40.1%;font-weight: 400; font-size: 16px; font-style: bold;">
                            Office Address: <input  class="fullname cert" name="" type="text" value="" id="fullname" style="width:40.1%;font-weight: 400; font-size: 16px; font-style: bold;">
                          </div>
                          <div class="col-md-12" style="color: #000000">
                            Guardian: <input  class="emer_name cert" name="" type="text" value="{{$course->emer_name}}" id="emer_name" style="width:43.3%;font-weight: 400; font-size: 16px; font-style: bold;">
                            Parent's/Guardian Contact No.:<input  class="fullname cert" name="" type="text" value="{{$course->emer_contact}}" id="fullname" style="width:30.43%;font-weight: 400; font-size: 16px; font-style: bold;">
                          </div>
                          <div class="col-md-12" style="color: #000000">
                            ...
                            Student's Contact No.: <input  class="fullname cert" name="" type="text" value="{{$course->ContactNo}}" id="fullname" style="width:36%;font-weight: 400; font-size: 16px; font-style: bold;">
                          </div>
                        ...
                        <div class="row footer-end">
                          <div class="col-12  d-flex justify-content-end" >
                            <div class="column" style="margin-right:80px;margin-top:15px"> 
                              ...
                              <div class=" d-flex justify-content-left" style="font-size: 20px;color:black;">Revision: 03</div>
                              <div class=" d-flex justify-content-left" style="font-size: 20px;color:black;">Date: 15 September 2025</div>
                            </div>
                  ...
                  <div class="tab-pane active" id="show" aria-labelledby="show-tab" role="tabpanel">
                    <div class="table-responsive">
                      <div class="col-sm-12">
                        ...
                        <input type="text" class=" col-sm-8 border-0 id" name="email" value="{{$course->email}}" id="email" style="font-weight:400;color:rgb(58, 57, 57)" hidden>
              ...
              <div class="row" >
                <div class="col-12"  style="color:#f5f2f2;font-weight:bold;font-size:12px">
                  ...
                  <div class="form-group">
                    ...
                    Gender: <br><label class="" id="gender" style="text-transform: capitalize;font-size:16px;color:lightyellow;font-style:italic;">{{$gender}}</label>
                    <hr>
